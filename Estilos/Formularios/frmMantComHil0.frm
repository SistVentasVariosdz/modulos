...
Begin VB.Form frmMantComHil 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdPrevious 
         Height          =   495
         Left            =   480
         Picture         =   "frmMantComHil0.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdNext 
         Height          =   495
         Left            =   960
         Picture         =   "frmMantComHil0.frx":0172
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmdFirst 
         Height          =   495
         Left            =   0
         Picture         =   "frmMantComHil0.frx":02E4
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Primero"
         Top             =   120
      ...
      Begin VB.CommandButton cmdLast 
         Height          =   495
         Left            =   1440
         Picture         =   "frmMantComHil0.frx":0456
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Ultimo"
         Top             =   120
   ...
   Begin Mantenimientos.MantFunc MantFunc1 
      ...
      _ExtentX        =   6297
      _ExtentY        =   953
      Custom          =   $"frmMantComHil0.frx":05C8
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
...
If Len(Trim(txtIdMatPri.Text)) = 0 Then
   amensaje.Codigo = CodeMsg.kMSG_ERR_VALIDA_DES_ORGANIZ
   VALIDA_DATOS = False
End If
