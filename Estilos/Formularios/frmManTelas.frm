   ...
   Begin VB.Frame Fradetalle 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cboFlg_Operatividad 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmManTelas.frx":0DE6
            Left            =   3780
            List            =   "frmManTelas.frx":0DE8
            Style           =   2  'Dropdown List
            TabIndex        =   44
            Top             =   1110
            Width           =   1485
...
Private Sub cboCod_FamTela_Click()
    ...
    Else
        ...
        strSQL = "SELECT Cod_UniMedCnfRec  FROM TG_CONTROL "
        Call BuscaCombo(DevuelveCampo(strSQL, cCONNECT), 2, Me.cboCod_UniMedcnf)
    End If
...
Dim iCol As Long
    ...
    With frmBusqGeneral3
        ...
        .DGridLista.Columns("Descripcion").Width = 3000
        .DGridLista.Columns("Merma_1").Width = 700
        .DGridLista.Columns("Merma_2").Width = 700
