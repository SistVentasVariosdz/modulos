...
Begin VB.Form FrmManTelasDet 
   ...
   Begin VB.Frame Frame2 
      ...
      Top             =   2280
      Width           =   5415
      Begin VB.TextBox txtRama_InclinacionTrama 
         Height          =   285
         Left            =   1440
         TabIndex        =   30
         Top             =   2040
   ...
   Begin VB.Frame Frame12 
      ...
      Top             =   2280
      Width           =   5535
      Begin VB.TextBox txtRama_Resinado_InclinacionTrama 
         Height          =   285
         Left            =   1440
         TabIndex        =   43
         Top             =   2040
   ...
   Begin VB.Frame Frame13 
      ...
      Top             =   6480
      Width           =   5415
      Begin VB.TextBox txtRama_Termo_InclinacionTrama 
         Height          =   285
         Left            =   1440
         TabIndex        =   74
         Top             =   2040
   ...
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   4339
      _ExtentY        =   910
      Custom          =   $"FrmManTelasDet.frx":0000
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   End
End
Attribute VB_Name = "FrmManTelasDet"
...
Private Sub CmdProcesos_Click()
    ...
    FrmManTelaCombDet.vCod_Tela = Me.sCod_Tela
    FrmManTelaCombDet.vruta = Me.vruta
    Load FrmManTelaCombDet

    FrmManTelaCombDet.Txtcod_Tela.Text = Me.sCod_Tela
    FrmManTelaCombDet.TxtDes_Tela.Text = Me.sDes_tela
    FrmManTelaCombDet.TxtCod_Comb.Text = Me.sCod_Comb
    FrmManTelaCombDet.TxtDes_Comb.Text = Me.sDes_Comb
    
    FrmManTelaCombDet.CARGA_GRID
    FrmManTelaCombDet.Show vbModal
    Set FrmManTelaCombDet = Nothing
...
Call CARGA_COMBOS
    ...
    strSQL = "Tx_Muestra_DATOS_TECNICOS_TELA_Cabecera '" & sCod_Tela & "','" & vruta & "'"
...
If rs.RecordCount Then
    ...
    Me.txtRama_InclinacionTrama = rs!AcaRama_Secado_Incli_Trama
    Me.txtRama_Resinado_InclinacionTrama = rs!AcaRama_Resinado_Incli_Trama
    Me.txtRama_Termo_InclinacionTrama = rs!AcaRama_Termo_Incli_Trama
...
On Error GoTo errGrabar
    ...
    If Trim(Me.txtRama_InclinacionTrama) = "" Then txtRama_InclinacionTrama = "0"
    If Trim(Me.txtRama_Resinado_InclinacionTrama) = "" Then txtRama_Resinado_InclinacionTrama = "0"
    If Trim(Me.txtRama_Termo_InclinacionTrama) = "" Then txtRama_Termo_InclinacionTrama = "0"



    strSQL = "UP_TX_ACTUALIZA_DATOS_TECNICOS_TELA_DETALLE'" & _
        sCod_Tela & "','" & vruta & "','"
...
strSQL = strSQL & Me.TxtRama_Resinado_Ancho_Entrada & "','" & Me.TxtRama_Resinado_Densidad & "','" & Me.TxtRama_Resinado_Ancho_Cadena & "','" & _
    ...
    Me.TxtRama_Termo_Ancho_Salida & "','" & Me.TxtRama_Termo_Densidad_Salida & "','" & cmbRama_Termo_Vapor & "','" & vusu & "','" & ComputerName & "','" & TxtCod_Receta.Text & "','" & CmbPrenda.Text & "','" & _
    Me.txtRama_InclinacionTrama & "','" & Me.txtRama_Resinado_InclinacionTrama & "','" & Me.txtRama_Termo_InclinacionTrama & "'"
...
Private Sub txtRama_InclinacionTrama_GotFocus()
SelectionText txtRama_InclinacionTrama
End Sub

Private Sub txtRama_InclinacionTrama_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
    SendKeys "{TAB}"
End If
End Sub
...
Private Sub txtRama_Resinado_InclinacionTrama_GotFocus()
SelectionText txtRama_Resinado_InclinacionTrama
End Sub

Private Sub txtRama_Resinado_InclinacionTrama_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
    SendKeys "{TAB}"
End If
End Sub
...
Private Sub txtRama_Termo_InclinacionTrama_GotFocus()
SelectionText txtRama_Termo_InclinacionTrama
End Sub

Private Sub txtRama_Termo_InclinacionTrama_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
    SendKeys "{TAB}"
End If
End Sub
