...
Begin VB.Form FrmManTela_Procesos_Textil 
   Caption         =   "Telas - Procesos Textiles"
   ClientHeight    =   6450
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6285
   ...
   Begin VB.Frame Frame1 
      ...
      Begin GridEX20.GridEX GridReg 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "FrmManTela_Procesos_Textil.frx":0000
         Column(2)       =   "FrmManTela_Procesos_Textil.frx":00C8
         FormatStylesCount=   6
         FormatStyle(1)  =   "FrmManTela_Procesos_Textil.frx":016C
         FormatStyle(2)  =   "FrmManTela_Procesos_Textil.frx":02A4
         FormatStyle(3)  =   "FrmManTela_Procesos_Textil.frx":0354
         FormatStyle(4)  =   "FrmManTela_Procesos_Textil.frx":0408
         FormatStyle(5)  =   "FrmManTela_Procesos_Textil.frx":04E0
         FormatStyle(6)  =   "FrmManTela_Procesos_Textil.frx":0598
         ImageCount      =   0
         PrinterProperties=   "FrmManTela_Procesos_Textil.frx":0678
      End
   End
   Begin Mantenimientos.MantFunc MantFunc1 
      ...
      _ExtentX        =   6297
      _ExtentY        =   953
      Custom          =   $"FrmManTela_Procesos_Textil.frx":0850
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   End
End
Attribute VB_Name = "FrmManTela_Procesos_Textil"
...
On Error GoTo ErrCargaGrid
    strSQL = "SM_Muestra_Procesos_Textiles_Tela '" & vCod_Tela & "'"
...
Sub LIMPIA()
    TxtCodigo.Text = ""
    TxtDescripcion.Text = ""
    TxtSecuencia.Text = DevuelveCampo("select isnull(max(secuencia),0) + 1 from tx_tela_procesos_textiles where cod_tela ='" & vCod_Tela & "'", cCONNECT)
End Sub
...
On Error GoTo ErrSalvarDatos
    ...
    strSQL = "EXEC Up_Man_Tx_Procesos_Textiles_Tela '" & sTipo & "','" & vCod_Tela & "','" & _
