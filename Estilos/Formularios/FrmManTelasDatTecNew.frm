...
Begin VB.Form FrmManTelasDatTecNew 
   ...
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   4339
      _ExtentY        =   900
      Custom          =   $"FrmManTelasDatTecNew.frx":0000
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   Begin VB.Frame Frame9 
      ...
      Begin VB.Label Label73 
         Caption         =   "    %E Acabado            %Primera %Tercera"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "FrmManTelasDatTecNew"
...
If Trim(Me.TxtCurva_Tenido) = "" Then TxtCurva_Tenido = "0"
    ...
    'Call BuscaCombo(rs!AcaRama_Secado_Vapor, 1, cmbRama_Vapor)
'    rs!AcaRama_Resinado_Secado_Ancho_Entrada
'    AcaRama_Resinado_Secado_Densidad_Entrada
'    AcaRama_Resinado_Ancho_Cadena
'    AcaRama_Resinado_Secado_Velocidad
'    AcaRama_Resinado_Secado_Temperatura
'    AcaRama_Resinado_Secado_SobreAlimentacion_Sup
'    AcaRama_Resinado_Secado_SobreAlimentacion_Inf
'    AcaRama_Resinado_Secado_SobreAlimentacion_Salida
'    AcaRama_Resinado_Secado_Presion
'    AcaRama_Resinado_Secado_Ancho_Salida
'    AcaRama_Resinado_Secado_Densidad_Salida
'    AcaRama_Resinado_Secado_Vapor
'    AcaRama_Termo_Secado_Ancho_Entrada
'    AcaRama_Termo_Secado_Densidad_Entrada
'    AcaRama_Termo_Ancho_Cadena
'    AcaRama_Termo_Secado_Velocidad
'    AcaRama_Termo_Secado_Temperatura
'    AcaRama_Termo_Secado_SobreAlimentacion_Sup
'    AcaRama_Termo_Secado_SobreAlimentacion_Inf
'    AcaRama_Termo_Secado_SobreAlimentacion_Salida
'    AcaRama_Termo_Secado_Presion
'    AcaRama_Termo_Secado_Ancho_Salida
'    AcaRama_Termo_Secado_Densidad_Salida
'    AcaRama_Termo_Secado_Vapor
...
strSQL = "UP_TX_ACTUALIZA_DATOS_TECNICOS_TELA_NUEVOS '" & _
        ...
        TxtPercha_Presion & "','" & TxtPercha_Alim_Rodillo & "','" & TxtPruSeca_Ancho_Tela & "','" & _
        ...
        TxtTambler_Ancho_Lavado & "','" & TxtTambler_Densidad & "','" & TxtTambler_Ancho_Proyectado & "','"
...
strSQL = strSQL & Me.TxtRama_Resinado_Ancho_Entrada & "','" & Me.TxtRama_Resinado_Densidad & "','" & Me.TxtRama_Resinado_Ancho_Cadena & "','" & _
    ...
    Me.TxtRama_Termo_Ancho_Salida & "','" & Me.TxtRama_Termo_Densidad_Salida & "','" & cmbRama_Termo_Vapor & "'"
...
cmbRama_Resinado_Vapor.AddItem ("N")
cmbRama_Resinado_Vapor.AddItem ("S")
cmbRama_Resinado_Vapor.ListIndex = 0
