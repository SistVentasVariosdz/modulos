...
Begin VB.Form frmMantComHil 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Componente Hilado"
   ClientHeight    =   5655
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5835
   ...
   Begin VB.Frame Fradetalle 
      ...
      Begin VB.TextBox txtDesHilado 
         ...
         Width           =   3480
      End
      Begin VB.CommandButton cmdBuscaMatPri 
         Caption         =   "..."
         Enabled         =   0   'False
         Height          =   330
         Left            =   2010
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdPrevious 
         Height          =   495
         Left            =   480
         Picture         =   "frmMantComHil.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton cmdNext 
         Height          =   495
         Left            =   960
         Picture         =   "frmMantComHil.frx":0172
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton cmdFirst 
         Height          =   495
         Left            =   0
         Picture         =   "frmMantComHil.frx":02E4
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Primero"
         Top             =   120
      ...
      Begin VB.CommandButton cmdLast 
         Height          =   495
         Left            =   1440
         Picture         =   "frmMantComHil.frx":0456
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Ultimo"
         Top             =   120
   ...
   End
End
Attribute VB_Name = "frmMantComHil"
...
Private Sub cmdBuscaMatPri_Click()
Dim oTipo As New frmBusqGeneral
Dim Rs As New ADODB.Recordset
Set oTipo.oParent = Me
oTipo.sQuery = "SELECT cod_matpri as Codigo, des_matpri as Descripcion FROM IT_MatPri"
oTipo.Cargar_Datos
oTipo.Show 1
If Codigo <> "" Then
    txtIdMatPri.Text = Codigo
    txtDesMatPri.Text = Descripcion
    Codigo = ""
End If
Set oTipo = Nothing
End Sub
Private Sub cmdBuscaMatPri_KeyDown(KeyCode As Integer, Shift As Integer)
AVANZA (KeyCode)
End Sub
...
Sub Cargar_Datos()
    ...
    StrSQL = "SG_Act_ComHil '" & txtIdHilado.Text & "','',0,'L'"
...
DGridLista.Columns(2).DataField = "por_componente"
DGridLista.Columns(0).Caption = "Cod.Mat.Prima"
DGridLista.Columns(1).Caption = "Mat.Prima"
DGridLista.Columns(2).Caption = "% Comp."
...
If txtIdMatPri.Text <> "" Then
    Con.BeginTrans
    Con.Execute "SG_Act_ComHil '" & _
    txtIdHilado.Text & "','" & _
    txtIdMatPri.Text & "'," & _
    Val(txtPorComp.Text) & ",'" & _
    sTipo & "'"
    Con.CommitTrans
...
If txtIdMatPri.Text <> "" Then
    Con.BeginTrans
    Con.Execute "SG_Act_ComHil '" & txtIdHilado.Text & "','" & txtIdMatPri.Text & "',0,'D'"
    Con.CommitTrans
    Dim amensaje As New clsMessages
...
If Len(Trim(txtIdMatPri.Text)) = 0 Then
   MsgBox "Ingrese la Materia Prima", vbInformation, Me.Caption
   VALIDA_DATOS = False
End If
...
End If
End Function
Private Sub txtIdPorComp_KeyDown(KeyCode As Integer, Shift As Integer)
AVANZA (KeyCode)
End Sub
...
Busca_FuncionErr:
    Set Rs_busca = Nothing
    ErrorHandler Err, "Busca_MatPri"
End Sub
Sub Busca_ComHil()
Dim Rs_busca As New ADODB.Recordset
On Error GoTo Busca_FuncionErr
B_sql = "SELECT * FROM IT_ComHil " & _
"WHERE cod_hiltel = '" & txtIdHilado.Text & "' " & _
"AND   cod_matpri = '" & txtIdMatPri.Text & "' "
Rs_busca.ActiveConnection = cCONNECT
Rs_busca.CursorType = adOpenStatic
Rs_busca.Open B_sql
If Not Rs_busca.EOF Then
    txtIdMatPri.Text = Rs_busca!cod_matpri
    txtPorComp.Text = Rs_busca!por_componente
    cmdBuscaMatPri.Enabled = False
    DESHABILITA_DATOS
    HabilitaMant Me.MantFunc1, "ADICIONAR/MODIFICAR/ELIMINAR"
    DGridLista.Enabled = True
...
Busca_FuncionErr:
    Set Rs_busca = Nothing
    ErrorHandler Err, "Busca_ComHil"
End Sub

Private Sub txtPorComp_KeyPress(KeyAscii As Integer)
    Call SoloNumeros(txtPorComp, KeyAscii, True, 2, 3)
End Sub
