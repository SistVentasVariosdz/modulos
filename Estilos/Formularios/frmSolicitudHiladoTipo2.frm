VERSION 5.00
Begin VB.Form frmSolicitudHiladoTipo2 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox txtPorc_Fibra_Poly_Negro 
         ...
         Width           =   825
      End
      Begin VB.TextBox txtPorc_Fibra_Poly_Crudo 
         Alignment       =   1  'Right Justify
         Height          =   285
         Left            =   5760
         TabIndex        =   10
      ...
      Begin VB.TextBox txtNE 
         ...
         Width           =   1425
      End
      Begin VB.CheckBox chkColor_Fibra_Poly_Crudo 
         Alignment       =   1  'Right Justify
         Height          =   200
         Left            =   5370
         TabIndex        =   9
   ...
   End
End
Attribute VB_Name = "frmSolicitudHiladoTipo2"
...
Sub SALVAR_DATOS()
    ...
    Con.Open
        ...
        StrSQL = StrSQL & _
        IIf(Me.chkColor_Fibra_Poly_Crudo.Value <> 0, "*", "") & "'," & _
        Me.txtPorc_Fibra_Poly_Crudo & ",'" & _
...
Private Sub txtPorc_Fibra_Poly_Crudo_KeyPress(KeyAscii As Integer)
    Call SoloNumeros(Me.txtPorc_Fibra_Poly_Crudo, KeyAscii, True, 2, 5)
End Sub

Private Sub txtPorc_Fibra_Poly_Crudo_LostFocus()
    If Trim(txtPorc_Fibra_Poly_Crudo.Text) = "" Then
        txtPorc_Fibra_Poly_Crudo.Text = "0"
    End If
End Sub
