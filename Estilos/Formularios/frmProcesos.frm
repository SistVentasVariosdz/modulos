...
Begin VB.Form frmProcesos 
   ...
   Begin VB.Frame FraDetalle 
      ...
      Top             =   3450
      Width           =   5760
      Begin VB.CheckBox chkFlg_Proceso_Pano 
         Caption         =   "&Proceso Paño"
         Height          =   255
         Left            =   225
         TabIndex        =   20
         Top             =   1965
...
Sub Carga_Datos()
    ...
    If Not Rs_Lista.EOF And Not Rs_Lista.BOF Then
        ...
        Else
            ...
            OpTenido.Value = True
        End If
        chkFlg_Proceso_Pano = IIf(Rs_Lista("Flg_Proceso_Pano").Value = "S", 1, 0)
    End If
End Sub
...
Sub HABILITA_DATOS()
    ...
    chkFlg_Proceso_Pano.Enabled = True
End Sub
...
Sub INHABILITA_DATOS()
    ...
    chkFlg_Proceso_Pano.Enabled = False
End Sub
...
Sub SALVAR_DATOS()
    ...
    Con.Open
        ...
        Trim(txtDes_ProTex.Text) & "',''," & Val(txtPrecio.Text) & ",'" & _
        IIf(OpTenido.Value = True, "T", "J") & "','" & _
        Trim(Right(CboCosteo.Text, 2)) & "', '" & _
        IIf(chkFlg_Proceso_Pano, "S", "N") & "'"
