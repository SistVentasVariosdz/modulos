...
Public Sub LibraryVBToSSDBGrid(ByRef oData As Object, ByRef pBuff As Variant, ByRef ssDBGrid As Object)  'As SSDataWidgets_B.ssDbGrid)
...
Public Sub EjecutaOpcionMenu(ByVal sNameOpcion As String, perfil As String, empresa As String)
On Error GoTo EjecutaOpcionMenu
    ...
    If sopcion = "C" Or sopcion = "P" Or sopcion = "M" Or sopcion = "N" Then
        If sDllName <> tDllName Then
          ...
          Else
              Set objFormDLL = New PruebaInteropFormLibrary1.clsForm '.clsForm      'CreateObject(sDllName & "." & sDllName & "." & nomfor)
          End If
        End If
...
Public Function Get_Datos_form(ByVal sopcion As String, ByRef rutexe As String, ByRef nomfor As String, ByRef nivel As Integer, ByRef Tipo As String, ByRef icono As String, ByRef cod_padre As String, ByRef des_opcion As String, ByRef ReadmeDoc As String)
