...
frmListaGeneral.SQuery = "SELECT cod_colcli as Codigo, nom_colcli as Descripcion " & _
"FROM TG_ColCli WHERE cod_cliente = '" & txtidcliente.Text & "'"
...
B_SQL = "UP_MAN_TG_PURORDCOL1 '" & txtidcliente.Text & "','" & _
 txtidPO.Text & "','" & txtIdEstCli.Text & "','" & txtIdcolor.Text & "', " & txtOrdColor.Text & "," & txtPor_AdicProd & "," & txtPre_AdicProd & ",'" & txtidcliente & "','U','" & stodo & "'"
...
End Sub
Sub CARGAR_DATOS()
B_SQL = "SG_Lista_Color '" & txtidcliente.Text & "', '" & _
txtidPO.Text & "','" & _
txtIdEstCli.Text & "'"
...
If txtidcliente.Text <> "" Then
    B_SQL = "SELECT * FROM " & _
    "TG_PurOrdCol " & _
    "WHERE cod_cliente = '" & txtidcliente.Text & "' " & _
    "AND   cod_purord  = '" & txtidPO.Text & "' " & _
    "AND   cod_estcli  = '" & txtIdEstCli.Text & "' " & _
    "AND   cod_colcli  = '" & txtIdcolor.Text & "'"
...
Dim Rs_busca As New ADODB.Recordset
If txtIdcolor.Text <> "" Then
    B_SQL = "SELECT * FROM TG_colcli WHERE " & _
    "cod_cliente = '" & txtidcliente.Text & "' AND " & _
    "cod_colcli  = '" & txtIdcolor.Text & "' "
    Rs_busca.ActiveConnection = cCONNECT
    Rs_busca.CursorType = adOpenStatic
    Rs_busca.Open B_SQL
    If Not Rs_busca.EOF Then
