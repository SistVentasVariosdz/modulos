...
Private Sub funAceptaCancelar_ActionClick(ByVal index As Integer, ByVal ActionType As Integer, ByVal ActionName As String)
On Error GoTo errores
    Dim obj As clsTG_ColCli
...
Private Sub funPresent_ActionClick(ByVal index As Integer, ByVal ActionType As Integer, ByVal ActionName As String)
    Select Case ActionName
    Case "ACEPTAR"
...
Private Function ValidarColCli(sCod_Cliente, sCod_TemCli, sCod_EStCli, sCod_ColCli) As Boolean
On Error GoTo errores
    Dim vbuff
    Dim obj As New clsTG_ColCli
...
Private Function AddPresent(ByVal sCod_Estpro As String, ByVal sDes_Present As String) As Boolean
On Error GoTo errores
        Dim obj As New clsTG_ColCli
