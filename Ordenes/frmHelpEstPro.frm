...
Begin VB.Form frmHelpEstPro 
   ...
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   4339
      _ExtentY        =   900
      Custom          =   "0~0~ACEPTAR~True~True~&Aceptar~0~0~1~~0~False~False~&OK~~1~0~CANCELAR~True~True~&Cancelar~0~0~2~~0~False~False~&Cancel~"
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin GridEX20.GridEX gexList 
         ...
         ColumnsCount    =   2
         Column(1)       =   "frmHelpEstPro.frx":0000
         Column(2)       =   "frmHelpEstPro.frx":00C8
         FormatStylesCount=   6
         FormatStyle(1)  =   "frmHelpEstPro.frx":016C
         FormatStyle(2)  =   "frmHelpEstPro.frx":02A4
         FormatStyle(3)  =   "frmHelpEstPro.frx":0354
         FormatStyle(4)  =   "frmHelpEstPro.frx":0408
         FormatStyle(5)  =   "frmHelpEstPro.frx":04E0
         FormatStyle(6)  =   "frmHelpEstPro.frx":0598
         ImageCount      =   0
         PrinterProperties=   "frmHelpEstPro.frx":0678
      End
...
StrSql = "EXEC SM_TM_LOTESTPRO '" & vusu & "','" & sCod_Cliente & "','" & sCod_PurOrd & "','" & Me.TxtEstCli.Text & "','" & _
            gexList.value(gexList.Columns("COD_ESTPRO").Index) & "'," & _
            gexList.value(gexList.Columns("NUM_SOLICITUD_CONS").Index) & ",'" & _
            gexList.value(gexList.Columns("COD_ESTPRO").Index) & "','" & _
            gexList.value(gexList.Columns("VERSION").Index) & "'"
