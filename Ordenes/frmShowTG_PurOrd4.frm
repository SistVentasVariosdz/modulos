...
Begin VB.Form frmShowTG_PurOrd 
   ...
   Begin FunctionsButtons.FunctButt FunctButt2 
      ...
      _ExtentX        =   26882
      _ExtentY        =   1111
      Custom          =   $"frmShowTG_PurOrd4.frx":0945
      Orientacion     =   0
      Style           =   0
      Language        =   2
      TypeImageList   =   0
   ...
   Begin FunctionsButtons.FunctButt FunctButt4 
      ...
      _ExtentX        =   26882
      _ExtentY        =   1111
      Custom          =   $"frmShowTG_PurOrd4.frx":0F22
      Orientacion     =   0
      Style           =   0
      Language        =   2
      TypeImageList   =   0
   ...
   Begin SSDataWidgets_B.SSDBGrid ssgrdDatos 
      ...
      Columns(0).HeadBackColor=   13595948
      Columns(0).ForeColor=   16711680
      ...
      Columns(8).Caption=   "Codigo de Embarque"
      Columns(8).Name =   "Cod_Embarque"
      Columns(8).DataField=   "Column 8"
      Columns(8).DataType=   8
      Columns(8).FieldLen=   256
      Columns(9).Width=   2672
      Columns(9).Caption=   "Descripción de Embarque"
      Columns(9).Name =   "Des_Embarque"
      Columns(9).DataField=   "Column 9"
      Columns(9).DataType=   8
      Columns(9).FieldLen=   256
      Columns(10).Width=   1693
      Columns(10).Caption=   "Temporada Cliente"
      Columns(10).Name=   "Cod_TemCli"
      Columns(10).DataField=   "Column 10"
      Columns(10).DataType=   8
      Columns(10).FieldLen=   256
      Columns(11).Width=   3122
      Columns(11).Caption=   "Nombre Temporada Cliente"
      Columns(11).Name=   "Nom_TemCli"
   ...
   Begin SSDataWidgets_B.SSDBGrid ssgrdDatos2 
      ...
      Groups(0).Columns(3).ForeColor=   16744448
      Groups(0).Columns(3).BackColor=   16777215
      Groups(0).Columns(4).Width=   1588
      ...
      Groups(0).Columns(4).ForeColor=   5197647
      Groups(0).Columns(4).BackColor=   16777215
      Groups(0).Columns(5).Width=   1402
      ...
      Groups(0).Columns(7).Width=   1614
      Groups(0).Columns(7).Visible=   0   'False
      Groups(0).Columns(7).Caption=   "Fec_Hora_Llegada_PO"
      Groups(0).Columns(7).Name=   "Fec_Hora_Llegada_PO"
      ...
      Groups(2).Columns(0).DataField=   "Column 12"
      Groups(2).Columns(0).DataType=   8
      Groups(2).Columns(0).FieldLen=   256
      Groups(2).Columns(0).HasHeadForeColor=   -1  'True
      Groups(2).Columns(0).HasForeColor=   -1  'True
      Groups(2).Columns(0).HeadForeColor=   16711680
      Groups(2).Columns(0).ForeColor=   16711680
      Groups(2).Columns(1).Width=   2117
      Groups(2).Columns(1).Caption=   "Pre.Costo"
      Groups(2).Columns(1).Name=   "PRECIO_COSTO"
      Groups(2).Columns(1).Alignment=   1
      Groups(2).Columns(1).CaptionAlignment=   2
      Groups(2).Columns(1).DataField=   "Column 13"
      Groups(2).Columns(1).DataType=   8
      Groups(2).Columns(1).FieldLen=   256
      Groups(2).Columns(1).HasHeadForeColor=   -1  'True
      Groups(2).Columns(1).HasForeColor=   -1  'True
      Groups(2).Columns(1).HasBackColor=   -1  'True
      Groups(2).Columns(1).HeadForeColor=   8421376
      Groups(2).Columns(1).ForeColor=   8421376
      Groups(2).Columns(1).BackColor=   16777215
      Groups(2).Columns(2).Width=   953
      Groups(2).Columns(2).Caption=   "Flag  "
      Groups(2).Columns(2).Name=   "Flg_PreDif"
      Groups(2).Columns(2).Alignment=   1
      Groups(2).Columns(2).CaptionAlignment=   0
      Groups(2).Columns(2).DataField=   "Column 14"
      ...
      Groups(4).Columns(0).DataField=   "Column 17"
      ...
      Groups(4).Columns(1).DataField=   "Column 18"
      ...
      Groups(5).Columns(0).DataField=   "Column 19"
      ...
      Groups(5).Columns(1).DataField=   "Column 20"
      ...
      Groups(6).Columns(0).DataField=   "Column 21"
      ...
      Groups(7).Columns(0).DataField=   "Column 22"
      ...
      Groups(8).Columns(0).DataField=   "Column 23"
...
Private Sub FunctButt1_ActionClick(ByVal Index As Integer, ByVal ActionType As Integer, ByVal ActionName As String)
    ...
    Select Case ActionName
        ...
        Case "MODIFICAR"
            ...
            oWizard.dtpFec_DespachoAct.Visible = True
            oWizard.txtCod_Destino.Visible = True
            oWizard.txtDes_Destino.Visible = True
            oWizard.cmdCod_Destino.Visible = True
            oWizard.labels(3).Visible = False
            oWizard.labels(1).Visible = True
...
Dim NVEZ As Integer
    ...
    Case "MODIFICARDET"
        ...
        Load oWizard
'        oWizard.dtpFec_LlegadaPO.value = ssgrdDatos2.Columns("Fec_Hora_Llegada_PO").Text
...
'        oWizard.dtpFec_DespachoActLOT.Enabled = False
    ...
    Case "INCORPORAR"
        ...
        oWizard.dtpFec_LlegadaPO.value = Me.ssgrdDatos.Columns("Fec_Hora_Llegada_PO").Text
    ...
    Case "DETALLEXTALLA"
        ...
        oWizard.sCod_Cliente = Me.sCod_Cliente
        oWizard.sCod_PurOrd = Me.ssgrdDatos.Columns("Cod_PurOrd").Text
        If IsNull(Me.ssgrdDatos2.Columns("Fec_Hora_Llegada_PO").Text) = False Then
            If Trim(Me.ssgrdDatos2.Columns("Fec_Hora_Llegada_PO").Text) <> "" Then
                oWizard.dtpFec_LlegadaPO.value = Me.ssgrdDatos2.Columns("Fec_Hora_Llegada_PO").Text
            End If
        End If
        Set oWizard.oParent = Me
        oWizard.LoadPOC oWizard.sCod_Cliente, oWizard.sCod_PurOrd
...
'        frmUpdateDatGenLotEst.txtCod_DivPreLOT.Text = ssgrdDatos2.Columns("Cod_DivPre").Text
        ...
        If ssgrdDatos2.Columns("Fec_DespachoAct").Text <> "" Then
            frmUpdateDatGenLotEst.dtpFec_DespachoOriLOT.value = ssgrdDatos2.Columns("Fec_DespachoAct").Text
        End If
        ...
        'sCadSQL = "SELECT PRECIO_COSTO FROM TG_LOTEST WHERE COD_CLIENTE = '' AND COD_PURORD = '' AND Cod_LotPurOrd = '' AND Cod_EstCli = '' "
        
        With frmUpdateDatGenLotEst
            .txtPrecioCostoLOT.Text = ssgrdDatos2.Columns("PRECIO_COSTO").Text
'                .txtCostoTela.Text = ssgrdDatos2.Columns("PreCost_Tela").Text
'                .txtCostoAvios.Text = ssgrdDatos2.Columns("PreCost_Avios").Text
'                .txtCostoMOD.Text = ssgrdDatos2.Columns("PreCost_MOD").Text
'                .txtCostoFOB.Text = ssgrdDatos2.Columns("PreCost_FOB").Text
'                .txtCostoFinanciero.Text = ssgrdDatos2.Columns("PreCost_Fiancieros").Text
'                .txtCostoFijo.Text = ssgrdDatos2.Columns("PreCost_Fijos").Text
        End With
...
'        frmUpdateDatGenLotEst.dtpFecAceptacionDelCliente.value = ssgrdDatos2.Columns("FEC_ACEPTACION_CLIENTE").Text
    ...
    Case "UPDSINPACK"
        ...
        With frmCambioSinglePrePack
            If ssgrdDatos2.Columns("Flg_PrePack").Text = "S" Then .optPrePackSi = True _
            Else .optPrePackNo = True
...
'                End If
            ...
            Case "LOTE_DESTINO"
                If Me.ssgrdDatos.Rows > 0 Then
                    If Me.ssgrdDatos2.Rows > 0 Then
                        Dim oCambioDestino As New frm_CambioDestinoLotePO
                        oCambioDestino.sCodCli = sCod_Cliente
                        oCambioDestino.sCodPurOrd = ssgrdDatos.Columns("Cod_PurOrd").Text
                        oCambioDestino.sCodLote = ssgrdDatos2.Columns("Cod_LotPurOrd").Text
                        oCambioDestino.sEstCli = ssgrdDatos2.Columns("Cod_EstCli").Text
                        oCambioDestino.sCodDestino = ssgrdDatos2.Columns("Cod_Destino").Text
                        oCambioDestino.sDesDestino = ssgrdDatos2.Columns("Des_Destino").Text
                        
                        oCambioDestino.Show 1
                        cmdBuscar_Click
                    Else
                        MsgBox "Ningun registro seleccionado", vbInformation, Me.Caption
                    End If
                Else
                    MsgBox "Ningun registro seleccionado", vbInformation, Me.Caption
                End If
            Case "DATOSGRAFICOS"
                If Me.ssgrdDatos.Rows > 0 Then
                    If Me.ssgrdDatos2.Rows > 0 Then
                        Dim oCambioDestinos As New frm_CambioDestinoLotePO
                        oCambioDestinos.sCodCli = sCod_Cliente
                        oCambioDestinos.sCodPurOrd = ssgrdDatos.Columns("Cod_PurOrd").Text
                        oCambioDestinos.sCodLote = ssgrdDatos2.Columns("Cod_LotPurOrd").Text
                        oCambioDestinos.sEstCli = ssgrdDatos2.Columns("Cod_EstCli").Text
                        oCambioDestinos.sCodDestino = ssgrdDatos2.Columns("Cod_Destino").Text
                        oCambioDestinos.sDesDestino = ssgrdDatos2.Columns("Des_Destino").Text
                        
                        oCambioDestinos.Show 1
                        cmdBuscar_Click
                    Else
                        MsgBox "Ningun registro seleccionado", vbInformation, Me.Caption
                    End If
            ...
            Case "CAMBIOPRECIOTALLA"
                
               If Me.ssgrdDatos.Rows > 0 Then
                  If Me.ssgrdDatos2.Rows > 0 Then
                    
                    Load FrmCambioPrecioPorTalla
                    Set FrmCambioPrecioPorTalla.oParent = Me
                    FrmCambioPrecioPorTalla.sCod_Cliente = Me.sCod_Cliente
                    FrmCambioPrecioPorTalla.sCod_PurOrd = Me.ssgrdDatos.Columns("Cod_PurOrd").Text
                    FrmCambioPrecioPorTalla.scod_LotPurOrd = ssgrdDatos2.Columns("Cod_LotPurOrd").Text
                    FrmCambioPrecioPorTalla.sCod_EStCli = ssgrdDatos2.Columns("Cod_EstCli").Text
                    FrmCambioPrecioPorTalla.sCod_TemCli = ssgrdDatos.Columns("Cod_EMBARQUE").Text 'ESTA ES LA TEMPORADA
                    FrmCambioPrecioPorTalla.BUSCAR
                    FrmCambioPrecioPorTalla.Show vbModal
                
                Set FrmCambioPrecioPorTalla = Nothing
                    Else
                        MsgBox "Ningun registro seleccionado", vbInformation, Me.Caption
                    End If
                Else
...
Private Sub txtAbr_Cliente_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        ...
        If Len(Trim(txtAbr_Cliente.Text)) > 0 Then
            Dim sCadSQL As String
            sCadSQL = "SELECT NOM_CLIENTE FROM TG_CLIENTE WHERE ABR_CLIENTE = '" & txtAbr_Cliente.Text & "'"
            txtNom_Cliente.Text = DevuelveCampo(sCadSQL, cCONNECT)
            
            If Len(txtNom_Cliente.Text) > 0 Then
                sCadSQL = "SELECT COD_CLIENTE FROM TG_CLIENTE WHERE ABR_CLIENTE = '" & txtAbr_Cliente.Text & "'"
                sCod_Cliente = DevuelveCampo(sCadSQL, cCONNECT)
            Else
                sCod_Cliente = ""
            End If
