...
Public Function Filtrar(ByVal sFlag As String, ByRef oForm As Object, Optional ByRef oControl As Variant, Optional ByRef oControlDes As Variant, Optional ByVal bShowMostrar As Variant) As Boolean
On Error GoTo errores
    ...
    If lExecFiltrar Then
       ...
       Case Is = "COD_ESTCLI"
            ...
            obj.ConexionString = cCONNECT
            vbuff = obj.ViewEStCliEst(oForm.sCod_Cliente, oForm.txtCod_TemCli.Text)
...
End Function
Public Function Mostrar(ByVal sFlag As String, ByRef oForm As Object, ByRef oControl As Variant, ByRef oControlDes As Variant) As Boolean
On Error GoTo errores
    Dim vbuff As Variant
    Dim obj As Object
    ...
    Select Case sFlag
        ...
        Case Is = "COD_ESTCLI"
               ...
               obj.ConexionString = cCONNECT
               Set frmDatos = frmDatos
               frmDatos.Buffer = obj.ViewEStCliEst(oForm.sCod_Cliente, oForm.txtCod_TemCli.Text)
               frmDatos.FormatString = "Codigo|Descripción"
               frmDatos.ColumnWidths = Array(1000, 3000, 0, 0, 0, 0, 0)
               frmDatos.ssgrdDatos.ColAlignment(0) = MSFlexGridLib.AlignmentSettings.flexAlignLeftCenter
               frmDatos.ssgrdDatos.ColAlignment(1) = MSFlexGridLib.AlignmentSettings.flexAlignLeftCenter
...
Public Function ControlKeyDown(KeyCode As Integer, ByRef oForm As Object, ByRef oControl As Object, ByRef oControlDes As Object) As Boolean
