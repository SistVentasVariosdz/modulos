...
Private Sub funcTip_Empaque_ActionClick(ByVal index As Integer, ByVal ActionType As Integer, ByVal ActionName As String)
...
For irow = 1 To GridEX1.RowCount
    ...
    For iCol = 1 To GridEX1.Columns.Count
        ...
        If Mid(GridEX1.Columns(iCol).Key, 1, 6) = "PROPOR" Then
            ...
            ssql = VBsprintf(ssql, sCod_Cliente, sCod_PurOrd, scod_LotPurOrd, _
            sCod_EStCli, GridEX1.value(GridEX1.Columns("Cod_ColCli").index), GridEX1.value(GridEX1.Columns("Cod_Talla").index), sSec_PurOrd, _
            Mid(GridEX1.Columns(iCol).Key, 8, 3), vDiferencia, 0, sValorInicializa, vusu, ComputerName, Me.sFlgOpcion_Nueva, vProporcion)
