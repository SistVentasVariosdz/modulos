...
Private Sub funDestino_ActionClick(ByVal index As Integer, ByVal ActionType As Integer, ByVal ActionName As String)
On Error GoTo errx
...
Private Sub funDivCli_ActionClick(ByVal index As Integer, ByVal ActionType As Integer, ByVal ActionName As String)
On Error GoTo errx
Dim obj As clsTG_LotColTal
    Select Case ActionName
        Case "ACEPTAR"
...
Private Sub funPagEmb_ActionClick(ByVal index As Integer, ByVal ActionType As Integer, ByVal ActionName As String)
On Error GoTo errx
Dim obj As clsTG_LotColTal
    Select Case ActionName
        Case "ACEPTAR"
...
Private Sub funEmbarque_ActionClick(ByVal index As Integer, ByVal ActionType As Integer, ByVal ActionName As String)
On Error GoTo errx
Dim obj As clsTG_LotColTal
    Select Case ActionName
        Case "ACEPTAR"
...
Private Sub funBanco_ActionClick(ByVal index As Integer, ByVal ActionType As Integer, ByVal ActionName As String)
On Error GoTo errx
Dim obj As clsTG_LotColTal
    Select Case ActionName
        Case "ACEPTAR"
