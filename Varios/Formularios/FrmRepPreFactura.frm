...
Begin VB.Form FrmRepPreFactura 
   Caption         =   "Reporte Pre Facturado"
   ClientHeight    =   6255
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   14385
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FunctionsButtons.FunctButt FunctButt1 
         ...
         _ExtentX        =   4339
         _ExtentY        =   900
         Custom          =   $"FrmRepPreFactura.frx":0000
         Orientacion     =   0
         Style           =   0
         Language        =   0
         TypeImageList   =   0
   ...
   Begin GridEX20.GridEX GridEX1 
      ...
      IntProp7        =   0
      FormatStylesCount=   7
      FormatStyle(1)  =   "FrmRepPreFactura.frx":0090
      FormatStyle(2)  =   "FrmRepPreFactura.frx":01C8
      FormatStyle(3)  =   "FrmRepPreFactura.frx":0278
      FormatStyle(4)  =   "FrmRepPreFactura.frx":032C
      FormatStyle(5)  =   "FrmRepPreFactura.frx":0404
      FormatStyle(6)  =   "FrmRepPreFactura.frx":04BC
      FormatStyle(7)  =   "FrmRepPreFactura.frx":059C
      ImageCount      =   0
      PrinterProperties=   "FrmRepPreFactura.frx":05BC
   End
   ...
   End
End
Attribute VB_Name = "FrmRepPreFactura"
