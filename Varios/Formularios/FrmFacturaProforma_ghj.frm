...
Begin VB.Form FrmFacturaProforma 
   ...
   ClientTop       =   615
   ClientWidth     =   14205
   Icon            =   "FrmFacturaProforma.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   9450
   ScaleWidth      =   14205
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Telas"
      TabPicture(0)   =   "FrmFacturaProforma.frx":000C
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "GridEX2"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Colores"
      TabPicture(1)   =   "FrmFacturaProforma.frx":0028
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         ColumnsCount    =   2
         Column(1)       =   "FrmFacturaProforma.frx":0044
         Column(2)       =   "FrmFacturaProforma.frx":010C
         FormatStylesCount=   8
         FormatStyle(1)  =   "FrmFacturaProforma.frx":01B0
         FormatStyle(2)  =   "FrmFacturaProforma.frx":02E8
         FormatStyle(3)  =   "FrmFacturaProforma.frx":0398
         FormatStyle(4)  =   "FrmFacturaProforma.frx":044C
         FormatStyle(5)  =   "FrmFacturaProforma.frx":0524
         FormatStyle(6)  =   "FrmFacturaProforma.frx":05DC
         FormatStyle(7)  =   "FrmFacturaProforma.frx":06BC
         FormatStyle(8)  =   "FrmFacturaProforma.frx":0768
         ImageCount      =   0
         PrinterProperties=   "FrmFacturaProforma.frx":0818
      End
      Begin GridEX20.GridEX GridEX2 
         ...
         ColumnHeaderHeight=   285
         ColumnsCount    =   2
         Column(1)       =   "FrmFacturaProforma.frx":09F0
         Column(2)       =   "FrmFacturaProforma.frx":0AB8
         FormatStylesCount=   8
         FormatStyle(1)  =   "FrmFacturaProforma.frx":0B5C
         FormatStyle(2)  =   "FrmFacturaProforma.frx":0C94
         FormatStyle(3)  =   "FrmFacturaProforma.frx":0D44
         FormatStyle(4)  =   "FrmFacturaProforma.frx":0DF8
         FormatStyle(5)  =   "FrmFacturaProforma.frx":0ED0
         FormatStyle(6)  =   "FrmFacturaProforma.frx":0F88
         FormatStyle(7)  =   "FrmFacturaProforma.frx":1068
         FormatStyle(8)  =   "FrmFacturaProforma.frx":1114
         ImageCount      =   0
         PrinterProperties=   "FrmFacturaProforma.frx":11C4
      End
   End
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbViaTransporte_Cli 
         Height          =   315
         ItemData        =   "FrmFacturaProforma.frx":139C
         Left            =   7560
         List            =   "FrmFacturaProforma.frx":139E
   ...
   Begin VB.Frame FraBuscar 
      ...
      Begin FunctionsButtons.FunctButt FunctButt1 
         ...
         _ExtentX        =   7355
         _ExtentY        =   926
         Custom          =   $"FrmFacturaProforma.frx":13A0
         Orientacion     =   0
         Style           =   1
         Language        =   0
         TypeImageList   =   0
...
Private Sub FunctButt1_ActionClick(ByVal Index As Integer, ByVal ActionType As Integer, ByVal ActionName As String)
   ...
   Case "IMPRIMIR"
    On Error GoTo xError:
        ...
        oo.Workbooks.Open vRuta & "\Factura_Proforma_Precotex.xlt"
        oo.Visible = True
...
'End Sub
'
Private Sub txtSer_OrdComp_Change()
