...
Begin VB.Form frmChoferes 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin GridEX20.GridEX gexTrans 
         ...
         IntProp7        =   0
         FormatStylesCount=   7
         FormatStyle(1)  =   "frmManChoferes.frx":0000
         FormatStyle(2)  =   "frmManChoferes.frx":0138
         FormatStyle(3)  =   "frmManChoferes.frx":01E8
         FormatStyle(4)  =   "frmManChoferes.frx":029C
         FormatStyle(5)  =   "frmManChoferes.frx":0374
         FormatStyle(6)  =   "frmManChoferes.frx":042C
         FormatStyle(7)  =   "frmManChoferes.frx":050C
         ImageCount      =   0
         PrinterProperties=   "frmManChoferes.frx":052C
      End
   End
   Begin Mantenimientos.MantFunc MantFunc1 
      ...
      _ExtentX        =   6297
      _ExtentY        =   953
      Custom          =   $"frmManChoferes.frx":0704
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
