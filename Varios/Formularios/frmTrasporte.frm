...
Begin VB.Form frmTransporte 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin GridEX20.GridEX gexTrans 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmTrasporte.frx":04B0
         Column(2)       =   "frmTrasporte.frx":0578
         FormatStylesCount=   6
         FormatStyle(1)  =   "frmTrasporte.frx":061C
         FormatStyle(2)  =   "frmTrasporte.frx":0754
         FormatStyle(3)  =   "frmTrasporte.frx":0804
         FormatStyle(4)  =   "frmTrasporte.frx":08B8
         FormatStyle(5)  =   "frmTrasporte.frx":0990
         FormatStyle(6)  =   "frmTrasporte.frx":0A48
         ImageCount      =   0
         PrinterProperties=   "frmTrasporte.frx":0B28
      End
   End
...
Set Me.gexTrans.ADORecordset = CargarRecordSetDesconectado(StrSql, cadena)
'ConfigurarGrid
