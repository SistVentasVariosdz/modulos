...
Begin VB.Form frmShowGuiasxFact_TelaTenidad_Exportacion 
   Caption         =   "Autorización de Pago de Documentos de Exportación"
   ClientHeight    =   8475
   ClientLeft      =   270
   ClientTop       =   615
   ClientWidth     =   11565
   Icon            =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   8475
   ScaleWidth      =   11565
   ...
   Begin GridEX20.GridEX GridEX2 
      ...
      IntProp7        =   0
      ColumnsCount    =   2
      Column(1)       =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":030A
      Column(2)       =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":03D2
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":0476
      FormatStyle(2)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":05AE
      FormatStyle(3)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":065E
      FormatStyle(4)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":0712
      FormatStyle(5)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":07EA
      FormatStyle(6)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":08A2
      ImageCount      =   0
      PrinterProperties=   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":0982
   End
   Begin GridEX20.GridEX GridEX3 
      ...
      IntProp7        =   0
      ColumnsCount    =   2
      Column(1)       =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":0B5A
      Column(2)       =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":0C22
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":0CC6
      FormatStyle(2)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":0DFE
      FormatStyle(3)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":0EAE
      FormatStyle(4)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":0F62
      FormatStyle(5)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":103A
      FormatStyle(6)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":10F2
      ImageCount      =   0
      PrinterProperties=   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":11D2
   End
   Begin VB.Frame FraBuscar 
      ...
      Begin FunctionsButtons.FunctButt FunctButt1 
         ...
         _ExtentX        =   5503
         _ExtentY        =   926
         Custom          =   $"frmShowGuiasxFact_TelaTenidad_Exportacion.frx":13AA
         Orientacion     =   0
         Style           =   1
         Language        =   0
         TypeImageList   =   0
   ...
   Begin GridEX20.GridEX GridEX1 
      ...
      ColumnHeaderHeight=   285
      ColumnsCount    =   2
      Column(1)       =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":1493
      Column(2)       =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":155B
      FormatStylesCount=   8
      FormatStyle(1)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":15FF
      FormatStyle(2)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":1737
      FormatStyle(3)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":17E7
      FormatStyle(4)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":189B
      FormatStyle(5)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":1973
      FormatStyle(6)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":1A2B
      FormatStyle(7)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":1B0B
      FormatStyle(8)  =   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":1BB7
      ImageCount      =   0
      PrinterProperties=   "frmShowGuiasxFact_TelaTenidad_Exportacion.frx":1C67
   End
   ...
   End
End
Attribute VB_Name = "frmShowGuiasxFact_TelaTenidad_Exportacion"
...
If Left(Cbo_Almacen, 2) = "TT" Then
  sSQL = "Ventas_Muestra_Documentos_Pendientes_Facturar_Tela_Tenida_Exportacion'" & Left(Cbo_Almacen, 3) & "','" & dtpFecEmiIni & "','" & dtpFecEmiFin & "','" & IIf(optTodos, "*", "") & "'"
...
Select Case ColIndex
  ...
  Case Is = GridEX1.Columns("Sel").Index
      ...
      sSQL = "Ventas_Cambio_Estado_DocAlm_Tela_Tenida_Exportacion '$','$','$','$','$',$,'$',$,$,'$','$','$',$,'$','$'"
...
If Left(Cbo_Almacen, 2) = "TT" Then
  ...
  ExecuteCommandSQL cConnect, "Ventas_Genera_Docum_Autorizados_Tela_Tenida_Exportacion '" & vusu & "','" & Left(Cbo_Almacen, 2) & "'"
...
strSQL = "Ventas_Ayuda_Almacenes_Tela_Exportacion"
