...
Begin VB.Form frmDocumentoVentaAnterior 
   Caption         =   "Adiciona NC ND"
   ClientHeight    =   8025
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   8490
   ...
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   4339
      _ExtentY        =   900
      Custom          =   $"frmDocumentoVentaAnterior.frx":0000
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   End
End
Attribute VB_Name = "frmDocumentoVentaAnterior"
...
Private sw_cancelar As Boolean
...
Dim rstAux As ADODB.Recordset
    ...
    With frmBusqGeneral
        ...
        .gexList.Columns("Origen").Visible = False
...
If Imp_Gastos_Finacieros.Text = "" Then
    Imp_Gastos_Finacieros.Text = 0
End If

If Imp_Otros.Text = "" Then
   Imp_Otros.Text = 0
End If
...
StrSQL = "Ventas_Up_Man '" & StrOption & "','" & strNum_Corre & "','" & txtCod_TipDoc & "','" & txtSer_Docum & "','" _
        ...
        & InpFec_RegDoc.Text & "','" & Trim(txtCod_Moneda.Text) & "'," & Imp_Gastos_Finacieros.Text & "," & Imp_Otros.Text & ",'" _
        & Des_Apos(txtGlosa.Text) & "','" & vusu & "','" & Trim(txtNro_Guias.Text) & "','" & Trim(txtNro_Ordener.Text) & "','" & txtNro_DocInter & "','" _
