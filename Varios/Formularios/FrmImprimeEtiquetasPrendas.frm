...
Begin VB.Form FrmImprimeEtiquetasPrendas 
   ...
   Begin VB.CommandButton cmdImprimirExcel 
   ...
   Begin GridEX20.GridEX GridEX1 
      ...
      FormatStylesCount=   7
      FormatStyle(1)  =   "FrmImprimeEtiquetasPrendas.frx":0000
      FormatStyle(2)  =   "FrmImprimeEtiquetasPrendas.frx":0128
      FormatStyle(3)  =   "FrmImprimeEtiquetasPrendas.frx":01D8
      FormatStyle(4)  =   "FrmImprimeEtiquetasPrendas.frx":028C
      FormatStyle(5)  =   "FrmImprimeEtiquetasPrendas.frx":0364
      FormatStyle(6)  =   "FrmImprimeEtiquetasPrendas.frx":041C
      FormatStyle(7)  =   "FrmImprimeEtiquetasPrendas.frx":04FC
      ImageCount      =   0
      PrinterProperties=   "FrmImprimeEtiquetasPrendas.frx":051C
   End
...
oop As String, oop1 As String, talla As String, TALLA1 As String, calidad As String, presentacion As String, DES_PRESET As String, sempresa As String) As Boolean
    ...
    Dim sTela As String
    SBARRA = Trim(oop) + Right("0000" + Trim(presentacion), 4) + Right("0000" + Trim(talla), 4)
...
Private Sub cmdImprimirExcel_Click()
Call Reporte
...
ruta = vRuta & "\rptImprimeEtiquetaPrenda.xlt"
       ...
       If rstAux.RecordCount > 0 Then
            .Show vbModal
             If fila_seleccionada > 0 And rstAux.RecordCount > 0 Then
                 ...
                 txtCod = Trim(rstAux!Cod) 'frmME.CODIGO Trim(rstAux!Cod)
                 txtDes = Trim(rstAux!Descripcion) 'frmME.Descripcion  'Trim(rstAux!Descripcion)
              Else
                 txtCod = ""
                 txtDes = ""
             End If
