...
Begin VB.Form frmDetalleCrudo_Ex 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin GridEX20.GridEX gexDetalle 
         ...
         IntProp7        =   0
         FormatStylesCount=   7
         FormatStyle(1)  =   "FrmAddOCOtrosCliente.frx":0000
         FormatStyle(2)  =   "FrmAddOCOtrosCliente.frx":0138
         FormatStyle(3)  =   "FrmAddOCOtrosCliente.frx":01E8
         FormatStyle(4)  =   "FrmAddOCOtrosCliente.frx":029C
         FormatStyle(5)  =   "FrmAddOCOtrosCliente.frx":0374
         FormatStyle(6)  =   "FrmAddOCOtrosCliente.frx":042C
         FormatStyle(7)  =   "FrmAddOCOtrosCliente.frx":050C
         ImageCount      =   0
         PrinterProperties=   "FrmAddOCOtrosCliente.frx":052C
      End
   End
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   4339
      _ExtentY        =   900
      Custom          =   $"FrmAddOCOtrosCliente.frx":0704
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
