...
Public Sub Busca_Opcion_lis(strCampo1 As String, strCampo2 As String, strCampo3 As String, StrTabla As String, txtCod As TextBox, txtDes As TextBox, lblEstado As Label, Opcion As Integer, frmME As Form)
...
Dim rstAux As ADODB.Recordset, strSql As String
   ...
   With frmBusqGeneral_Lis
        ...
        If frmME.codigo <> "" And rstAux.RecordCount > 0 Then
            txtCod = Trim(rstAux!Cod)
            txtDes = Trim(rstAux!Descripcion)
            lblEstado = Trim(rstAux!des_status_parte_cobranza)
