...
Begin VB.Form frmShowGuiasxFact_TelaTenida 
   ...
   ClientTop       =   615
   ClientWidth     =   15120
   Icon            =   "frmShowGuiasxFact_TelaTenidad.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   8040
   ScaleWidth      =   15120
   ...
   Begin GridEX20.GridEX GridEX2 
      ...
      IntProp7        =   0
      ColumnsCount    =   2
      Column(1)       =   "frmShowGuiasxFact_TelaTenidad.frx":030A
      Column(2)       =   "frmShowGuiasxFact_TelaTenidad.frx":03D2
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmShowGuiasxFact_TelaTenidad.frx":0476
      FormatStyle(2)  =   "frmShowGuiasxFact_TelaTenidad.frx":05AE
      FormatStyle(3)  =   "frmShowGuiasxFact_TelaTenidad.frx":065E
      FormatStyle(4)  =   "frmShowGuiasxFact_TelaTenidad.frx":0712
      FormatStyle(5)  =   "frmShowGuiasxFact_TelaTenidad.frx":07EA
      FormatStyle(6)  =   "frmShowGuiasxFact_TelaTenidad.frx":08A2
      ImageCount      =   0
      PrinterProperties=   "frmShowGuiasxFact_TelaTenidad.frx":0982
   End
   Begin GridEX20.GridEX GridEX3 
      ...
      IntProp7        =   0
      ColumnsCount    =   2
      Column(1)       =   "frmShowGuiasxFact_TelaTenidad.frx":0B5A
      Column(2)       =   "frmShowGuiasxFact_TelaTenidad.frx":0C22
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmShowGuiasxFact_TelaTenidad.frx":0CC6
      FormatStyle(2)  =   "frmShowGuiasxFact_TelaTenidad.frx":0DFE
      FormatStyle(3)  =   "frmShowGuiasxFact_TelaTenidad.frx":0EAE
      FormatStyle(4)  =   "frmShowGuiasxFact_TelaTenidad.frx":0F62
      FormatStyle(5)  =   "frmShowGuiasxFact_TelaTenidad.frx":103A
      FormatStyle(6)  =   "frmShowGuiasxFact_TelaTenidad.frx":10F2
      ImageCount      =   0
      PrinterProperties=   "frmShowGuiasxFact_TelaTenidad.frx":11D2
   End
   Begin VB.Frame FraBuscar 
      ...
      Begin FunctionsButtons.FunctButt FunctButt1 
         ...
         _ExtentX        =   5503
         _ExtentY        =   926
         Custom          =   $"frmShowGuiasxFact_TelaTenidad.frx":13AA
         Orientacion     =   0
         Style           =   1
         Language        =   0
         TypeImageList   =   0
   ...
   Begin GridEX20.GridEX GridEX1 
      ...
      ColumnHeaderHeight=   285
      ColumnsCount    =   2
      Column(1)       =   "frmShowGuiasxFact_TelaTenidad.frx":1495
      Column(2)       =   "frmShowGuiasxFact_TelaTenidad.frx":155D
      FormatStylesCount=   8
      FormatStyle(1)  =   "frmShowGuiasxFact_TelaTenidad.frx":1601
      FormatStyle(2)  =   "frmShowGuiasxFact_TelaTenidad.frx":1739
      FormatStyle(3)  =   "frmShowGuiasxFact_TelaTenidad.frx":17E9
      FormatStyle(4)  =   "frmShowGuiasxFact_TelaTenidad.frx":189D
      FormatStyle(5)  =   "frmShowGuiasxFact_TelaTenidad.frx":1975
      FormatStyle(6)  =   "frmShowGuiasxFact_TelaTenidad.frx":1A2D
      FormatStyle(7)  =   "frmShowGuiasxFact_TelaTenidad.frx":1B0D
      FormatStyle(8)  =   "frmShowGuiasxFact_TelaTenidad.frx":1BB9
      ImageCount      =   0
      PrinterProperties=   "frmShowGuiasxFact_TelaTenidad.frx":1C69
   End
...
If Left(Cbo_Almacen, 2) = "30" Or Left(Cbo_Almacen, 2) = "31" Then
  sSql = "Ventas_Muestra_Documentos_Pendientes_Facturar_Tela_Tenida '" & Left(Cbo_Almacen, 3) & "','" & dtpFecEmiIni & "','" & dtpFecEmiFin & "','" & IIf(optTodos, "*", "") & "'"
  lbCod_Color.Visible = True
  lbDes_Color.Visible = True
ElseIf Left(Cbo_Almacen, 2) = "20" Then
...
GridEX1.Columns("Partida").Width = 1000
...
GridEX1.Columns("Gastos Financieros").Width = 0
...
MsgBox "Se Genero Con Exito La Factura"
