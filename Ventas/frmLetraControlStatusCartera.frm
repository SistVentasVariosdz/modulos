...
Begin VB.Form frmLetraControlStatusCartera 
   ...
   ClientTop       =   1155
   ClientWidth     =   6570
   Icon            =   "frmLetraControlStatusCartera.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2670
   ...
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   4339
      _ExtentY        =   900
      Custom          =   $"frmLetraControlStatusCartera.frx":030A
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   End
End
Attribute VB_Name = "frmLetraControlStatusCartera"
