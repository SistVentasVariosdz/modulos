...
Begin VB.Form frmShowVoucher 
   ...
   Begin VB.Frame fraDatos 
      ...
      Begin FunctionsButtons.FunctButt FunctButt3 
         ...
         _ExtentX        =   4339
         _ExtentY        =   900
         Custom          =   $"frmShowVoucher.frx":0000
         Orientacion     =   0
         Style           =   0
         Language        =   0
         TypeImageList   =   0
   ...
   Begin GridEX20.GridEX GridEX1 
      ...
      ColumnsCount    =   2
      Column(1)       =   "frmShowVoucher.frx":0096
      Column(2)       =   "frmShowVoucher.frx":015E
      FormatStylesCount=   8
      FormatStyle(1)  =   "frmShowVoucher.frx":0202
      FormatStyle(2)  =   "frmShowVoucher.frx":033A
      FormatStyle(3)  =   "frmShowVoucher.frx":03EA
      FormatStyle(4)  =   "frmShowVoucher.frx":049E
      FormatStyle(5)  =   "frmShowVoucher.frx":0576
      FormatStyle(6)  =   "frmShowVoucher.frx":062E
      FormatStyle(7)  =   "frmShowVoucher.frx":070E
      FormatStyle(8)  =   "frmShowVoucher.frx":07BA
      ImageCount      =   0
      PrinterProperties=   "frmShowVoucher.frx":086A
   End
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   2011
      _ExtentY        =   5927
      Custom          =   $"frmShowVoucher.frx":0A42
      Orientacion     =   1
      Style           =   1
      Language        =   0
      TypeImageList   =   0
