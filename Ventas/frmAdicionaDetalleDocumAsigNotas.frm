...
Begin VB.Form frmAdicionaDetalleDocumAsigNotas 
   ...
   Begin GridEX20.GridEX GridEX1 
      ...
      ColumnsCount    =   2
      Column(1)       =   "frmAdicionaDetalleDocumAsigNotas.frx":0000
      Column(2)       =   "frmAdicionaDetalleDocumAsigNotas.frx":00C8
      FormatStylesCount=   8
      FormatStyle(1)  =   "frmAdicionaDetalleDocumAsigNotas.frx":016C
      FormatStyle(2)  =   "frmAdicionaDetalleDocumAsigNotas.frx":02A4
      FormatStyle(3)  =   "frmAdicionaDetalleDocumAsigNotas.frx":0354
      FormatStyle(4)  =   "frmAdicionaDetalleDocumAsigNotas.frx":0408
      FormatStyle(5)  =   "frmAdicionaDetalleDocumAsigNotas.frx":04E0
      FormatStyle(6)  =   "frmAdicionaDetalleDocumAsigNotas.frx":0598
      FormatStyle(7)  =   "frmAdicionaDetalleDocumAsigNotas.frx":0678
      FormatStyle(8)  =   "frmAdicionaDetalleDocumAsigNotas.frx":0724
      ImageCount      =   0
      PrinterProperties=   "frmAdicionaDetalleDocumAsigNotas.frx":07D4
   End
   Begin GridEX20.GridEX GridEX2 
      ...
      ColumnHeaderHeight=   285
      ColumnsCount    =   2
      Column(1)       =   "frmAdicionaDetalleDocumAsigNotas.frx":09AC
      Column(2)       =   "frmAdicionaDetalleDocumAsigNotas.frx":0A74
      FormatStylesCount=   8
      FormatStyle(1)  =   "frmAdicionaDetalleDocumAsigNotas.frx":0B18
      FormatStyle(2)  =   "frmAdicionaDetalleDocumAsigNotas.frx":0C50
      FormatStyle(3)  =   "frmAdicionaDetalleDocumAsigNotas.frx":0D00
      FormatStyle(4)  =   "frmAdicionaDetalleDocumAsigNotas.frx":0DB4
      FormatStyle(5)  =   "frmAdicionaDetalleDocumAsigNotas.frx":0E8C
      FormatStyle(6)  =   "frmAdicionaDetalleDocumAsigNotas.frx":0F44
      FormatStyle(7)  =   "frmAdicionaDetalleDocumAsigNotas.frx":1024
      FormatStyle(8)  =   "frmAdicionaDetalleDocumAsigNotas.frx":10D0
      ImageCount      =   0
      PrinterProperties=   "frmAdicionaDetalleDocumAsigNotas.frx":1180
   End
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   4339
      _ExtentY        =   900
      Custom          =   $"frmAdicionaDetalleDocumAsigNotas.frx":1358
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
