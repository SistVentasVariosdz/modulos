...
Begin VB.Form frmTransaccionesAddCuadreDet 
   ...
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   6588
      _ExtentY        =   900
      Custom          =   $"frmTransaccionesAddCuadreDet.frx":0000
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   Begin GridEX20.GridEX GridEX1 
      ...
      ImageCount      =   1
      ImagePicture1   =   "frmTransaccionesAddCuadreDet.frx":00DE
      DataMode        =   1
      ColumnHeaderHeight=   285
      ColumnsCount    =   2
      Column(1)       =   "frmTransaccionesAddCuadreDet.frx":0430
      Column(2)       =   "frmTransaccionesAddCuadreDet.frx":04F8
      FormatStylesCount=   8
      FormatStyle(1)  =   "frmTransaccionesAddCuadreDet.frx":059C
      FormatStyle(2)  =   "frmTransaccionesAddCuadreDet.frx":06D4
      FormatStyle(3)  =   "frmTransaccionesAddCuadreDet.frx":0784
      FormatStyle(4)  =   "frmTransaccionesAddCuadreDet.frx":0838
      FormatStyle(5)  =   "frmTransaccionesAddCuadreDet.frx":0910
      FormatStyle(6)  =   "frmTransaccionesAddCuadreDet.frx":09C8
      FormatStyle(7)  =   "frmTransaccionesAddCuadreDet.frx":0AA8
      FormatStyle(8)  =   "frmTransaccionesAddCuadreDet.frx":0F60
      ImageCount      =   1
      ImagePicture(1) =   "frmTransaccionesAddCuadreDet.frx":13AC
      PrinterProperties=   "frmTransaccionesAddCuadreDet.frx":16FE
   End
End
Attribute VB_Name = "frmTransaccionesAddCuadreDet"
...
Public StrSql As String, strCod_Anexo As String, strCod_TipAnexo, strTipo_Det As String, _
       ...
       dTipo_Cambio As Double, StrSql_Man As String
...
Case Is = "ELIMINAR"
  ...
  If MsgBox("Esta seguro de Eliminar este Detalle", vbYesNo, "IMPORTANTE") = vbYes Then
    If strTipo_Det = gcAnticipos Then
      lvSql = StrSql_Man & "'D'," & intNum_Transaccion & ",'" & dFecha & "'," & GridEX1.Value(GridEX1.Columns("Secuencia").Index) & ",'" _
    ...
    Else
      lvSql = StrSql_Man & "'D'," & intNum_Transaccion & ",'" & dFecha & "'," & GridEX1.Value(GridEX1.Columns("Secuencia").Index) & ",'" _
              & GridEX1.Value(GridEX1.Columns("Num_Corre").Index) & "'," & GridEX1.Value(GridEX1.Columns("Imp_Cancelado").Index) & "," & dTipo_Cambio
    End If
