...
Begin VB.Form frmTransaccionesUpdCuadreManFinan 
   ClientHeight    =   3480
   ClientLeft      =   1080
   ClientTop       =   2370
   ClientWidth     =   9135
   ...
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   4339
      _ExtentY        =   900
      Custom          =   $"frmTransaccionesUpdCuadreManFinan.frx":0000
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   End
End
Attribute VB_Name = "frmTransaccionesUpdCuadreManFinan"
...
SQL = "CN_Ventas_Trans_Cobranz_Detalle_Principal_Finanzas '" & StrOption & "','" & dFecha & "'," & intSecuencia & "," _
       & intSecuencia_Det & ",'" & txtCod_Cobranza.Text & "','" & "" & "','" & "" & "'," _
       & Format(txtImporte.Text, "######.00") & ",'" _
       & TxtObservacion & "'," & txtTipo_Cambio & "," & txtTipo_Cambio_Otros & ",'" & strNum_Corre_Otros & " '," & txtNum_Cuota
...
Private Sub txtCod_Cobranza_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then Call Busca_Opcion("Cod_Concepto_Cobranza", "Descripcion + ' (' + DBO.CN_VENTAS_DEVUELVE_CTACONTABLE_CONCEPTO_COBRANZA (Cod_Concepto_Cobranza , GETDATE()) + ') ' ", "Cn_Ventas_Conceptos_Cobranza Where Flg_Financiamientos = 'S' and ", txtCod_Cobranza, txtDes_Cobranza, 1, Me)
End Sub
...
Private Sub txtNro_Doc_Otros_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then Busca_Opcion_Cuota "Fi_Muestra_Cuotas_Financiamientos_Cobranzas '" & dFecha & "'," & intSecuencia & ",'" & txtCod_Cobranza & "'", txtNro_Doc_Otros, txtNum_Cuota, 1, Me
End Sub

Private Sub txtNum_Cuota_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then Busca_Opcion_Cuota "Fi_Muestra_Cuotas_Financiamientos_Cobranzas '" & dFecha & "'," & intSecuencia & ",'" & txtCod_Cobranza & "'", txtNro_Doc_Otros, txtNum_Cuota, 2, Me
End Sub
