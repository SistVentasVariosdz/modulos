...
Begin VB.Form frmMovimientosDetalleAddBusDoc 
   Caption         =   "Form1"
   ClientHeight    =   6990
   ClientLeft      =   1335
   ClientTop       =   1785
   ...
   Begin GridEX20.GridEX gexGrid1 
      ...
      IntProp1        =   0
      ColumnsCount    =   3
      Column(1)       =   "frmMovimientosDetalleAddBusDoc.frx":0000
      Column(2)       =   "frmMovimientosDetalleAddBusDoc.frx":00F4
      Column(3)       =   "frmMovimientosDetalleAddBusDoc.frx":01E0
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmMovimientosDetalleAddBusDoc.frx":02AC
      FormatStyle(2)  =   "frmMovimientosDetalleAddBusDoc.frx":03E4
      FormatStyle(3)  =   "frmMovimientosDetalleAddBusDoc.frx":0494
      FormatStyle(4)  =   "frmMovimientosDetalleAddBusDoc.frx":0548
      FormatStyle(5)  =   "frmMovimientosDetalleAddBusDoc.frx":0620
      FormatStyle(6)  =   "frmMovimientosDetalleAddBusDoc.frx":06D8
      ImageCount      =   0
      PrinterProperties=   "frmMovimientosDetalleAddBusDoc.frx":07B8
   End
   Begin FunctionsButtons.FunctButt fncBuscar 
      ...
      _ExtentX        =   4339
      _ExtentY        =   661
      Custom          =   $"frmMovimientosDetalleAddBusDoc.frx":0990
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   End
End
Attribute VB_Name = "frmMovimientosDetalleAddBusDoc"
