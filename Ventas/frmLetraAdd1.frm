...
Begin VB.Form frmLetraAdd1 
   ...
   Begin VB.Frame frFacturas 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Label lbSeleccionar 
            ...
            Height          =   195
            Left            =   5760
            MouseIcon       =   "frmLetraAdd1.frx":0397
      ...
      Begin GridEX20.GridEX gexGrid2 
         ...
         IntProp1        =   0
         ColumnsCount    =   3
         Column(1)       =   "frmLetraAdd1.frx":06A1
         Column(2)       =   "frmLetraAdd1.frx":0795
         Column(3)       =   "frmLetraAdd1.frx":0881
         FormatStylesCount=   6
         FormatStyle(1)  =   "frmLetraAdd1.frx":094D
         FormatStyle(2)  =   "frmLetraAdd1.frx":0A85
         FormatStyle(3)  =   "frmLetraAdd1.frx":0B35
         FormatStyle(4)  =   "frmLetraAdd1.frx":0BE9
         FormatStyle(5)  =   "frmLetraAdd1.frx":0CC1
         FormatStyle(6)  =   "frmLetraAdd1.frx":0D79
         ImageCount      =   0
         PrinterProperties=   "frmLetraAdd1.frx":0E59
      End
      Begin GridEX20.GridEX gexGrid1 
         ...
         IntProp1        =   0
         ColumnsCount    =   3
         Column(1)       =   "frmLetraAdd1.frx":1031
         Column(2)       =   "frmLetraAdd1.frx":1125
         Column(3)       =   "frmLetraAdd1.frx":1211
         FormatStylesCount=   6
         FormatStyle(1)  =   "frmLetraAdd1.frx":12DD
         FormatStyle(2)  =   "frmLetraAdd1.frx":1415
         FormatStyle(3)  =   "frmLetraAdd1.frx":14C5
         FormatStyle(4)  =   "frmLetraAdd1.frx":1579
         FormatStyle(5)  =   "frmLetraAdd1.frx":1651
         FormatStyle(6)  =   "frmLetraAdd1.frx":1709
         ImageCount      =   0
         PrinterProperties=   "frmLetraAdd1.frx":17E9
      End
   ...
   Begin VB.Frame frLetra 
      ...
      Begin GridEX20.GridEX gexLetra 
         ...
         ColumnHeaderHeight=   285
         ColumnsCount    =   2
         Column(1)       =   "frmLetraAdd1.frx":1A57
         Column(2)       =   "frmLetraAdd1.frx":1B1F
         FormatStylesCount=   9
         FormatStyle(1)  =   "frmLetraAdd1.frx":1BC3
         FormatStyle(2)  =   "frmLetraAdd1.frx":1CFB
         FormatStyle(3)  =   "frmLetraAdd1.frx":1DAB
         FormatStyle(4)  =   "frmLetraAdd1.frx":1E5F
         FormatStyle(5)  =   "frmLetraAdd1.frx":1F37
         FormatStyle(6)  =   "frmLetraAdd1.frx":1FEF
         FormatStyle(7)  =   "frmLetraAdd1.frx":20CF
         FormatStyle(8)  =   "frmLetraAdd1.frx":24DB
         FormatStyle(9)  =   "frmLetraAdd1.frx":28EB
         ImageCount      =   0
         PrinterProperties=   "frmLetraAdd1.frx":2A73
      End
   ...
   End
End
Attribute VB_Name = "frmLetraAdd1"
...
Private Sub CmdBack_Click()
    ...
    RsGrid1.Fields("Monto").Value = gexGrid2.Value(gexGrid1.Columns("Monto").Index)
    RsGrid1.Fields("Monto1").Value = gexGrid2.Value(gexGrid1.Columns("Monto1").Index)
    RsGrid1.Update
...
Private Sub cmdNext_Click()
    ...
    RsGrid2.Fields("Monto").Value = gexGrid1.Value(gexGrid1.Columns("Monto").Index)
    RsGrid2.Fields("Monto1").Value = gexGrid1.Value(gexGrid1.Columns("Monto1").Index)
    RsGrid2.Update
...
Private Sub frOpciones_DragDrop(Source As Control, X As Single, Y As Single)
...
Private Sub gexGrid1_AfterColEdit(ByVal ColIndex As Integer)
  ...
  Case Is = gexGrid1.Columns("Monto").Index
    If CDbl(gexGrid1.Value(gexGrid1.Columns("Monto").Index)) <= 0 Then
      MsgBox "El Monto del documento debe ser Mayor a Cero", vbInformation, "AVISO"
      gexGrid1.Value(gexGrid1.Columns("Monto").Index) = gexGrid1.Value(gexGrid1.Columns("Monto1").Index)
    End If
    
    If CDbl(gexGrid1.Value(gexGrid1.Columns("Monto").Index)) > CDbl(gexGrid1.Value(gexGrid1.Columns("Monto1").Index)) Then
...
If RsGrid1.RecordCount Then
    ...
    RsGrid2.Fields.Append RsGrid1.Fields("Monto").Name, adDouble
    RsGrid2.Fields.Append RsGrid1.Fields("Monto1").Name, adDouble
    RsGrid2.Open
...
Sub ConfigurarGrid(mGridEx As GridEx)
    mGridEx.Columns(2).Width = 1575
    mGridEx.Columns(3).Width = 945
    mGridEx.Columns(4).Width = 975
    mGridEx.Columns("Correlativo").Visible = False
    mGridEx.Columns("Monto1").Visible = False
    mGridEx.Columns("Monto").Format = "###,###.00"
End Sub
...
Dim I As Integer
    ...
    For I = 1 To mRs.RecordCount
        Monto = Monto + mRs.Fields("Monto").Value
        mRs.MoveNext
    Next
...
Dim I As Integer
    ...
    If gexGrid2.RowCount > 0 Then
      ...
      gexGrid2.MoveFirst
      For I = 1 To gexGrid2.RowCount
          Monto = Monto + gexGrid2.Value(gexGrid2.Columns("Monto").Index)
...
For I = 1 To gexLetra.RowCount
  ...
  If Not (rs.BOF Or rs.EOF) Then
    ...
    frmLetra.strNum_Corre_Let = rs!Num_Corre
  End If
...
gexGrid2.MoveFirst
For I = 1 To gexGrid2.RowCount
  SQL = "Ventas_Up_Man_Letras_Facturas '" & gexGrid2.Value(gexGrid2.Columns("Correlativo").Index) & "'," & gexGrid2.Value(gexGrid2.Columns("Monto").Index) & "," & intCod_Grupo
  Set rs = CargarRecordSetDesconectado(SQL, cCONNECT)
  gexGrid2.MoveNext
