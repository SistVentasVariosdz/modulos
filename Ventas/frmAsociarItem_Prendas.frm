...
Begin VB.Form frmAsociarItem_Prendas 
   Caption         =   "Regularización de Packing con Factura de Prendas"
   ClientHeight    =   8475
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   14265
   ...
   Begin GridEX20.GridEX GridEX4 
      ...
      IntProp7        =   0
      ColumnsCount    =   2
      Column(1)       =   "frmAsociarItem_Prendas.frx":0000
      Column(2)       =   "frmAsociarItem_Prendas.frx":00C8
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmAsociarItem_Prendas.frx":016C
      FormatStyle(2)  =   "frmAsociarItem_Prendas.frx":02A4
      FormatStyle(3)  =   "frmAsociarItem_Prendas.frx":0354
      FormatStyle(4)  =   "frmAsociarItem_Prendas.frx":0408
      FormatStyle(5)  =   "frmAsociarItem_Prendas.frx":04E0
      FormatStyle(6)  =   "frmAsociarItem_Prendas.frx":0598
      ImageCount      =   0
      PrinterProperties=   "frmAsociarItem_Prendas.frx":0678
   End
   Begin GridEX20.GridEX GridEX3 
      ...
      IntProp7        =   0
      ColumnsCount    =   2
      Column(1)       =   "frmAsociarItem_Prendas.frx":0850
      Column(2)       =   "frmAsociarItem_Prendas.frx":0918
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmAsociarItem_Prendas.frx":09BC
      FormatStyle(2)  =   "frmAsociarItem_Prendas.frx":0AF4
      FormatStyle(3)  =   "frmAsociarItem_Prendas.frx":0BA4
      FormatStyle(4)  =   "frmAsociarItem_Prendas.frx":0C58
      FormatStyle(5)  =   "frmAsociarItem_Prendas.frx":0D30
      FormatStyle(6)  =   "frmAsociarItem_Prendas.frx":0DE8
      ImageCount      =   0
      PrinterProperties=   "frmAsociarItem_Prendas.frx":0EC8
   End
   Begin GridEX20.GridEX GridEX2 
      ...
      IntProp7        =   0
      ColumnsCount    =   2
      Column(1)       =   "frmAsociarItem_Prendas.frx":10A0
      Column(2)       =   "frmAsociarItem_Prendas.frx":1168
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmAsociarItem_Prendas.frx":120C
      FormatStyle(2)  =   "frmAsociarItem_Prendas.frx":1344
      FormatStyle(3)  =   "frmAsociarItem_Prendas.frx":13F4
      FormatStyle(4)  =   "frmAsociarItem_Prendas.frx":14A8
      FormatStyle(5)  =   "frmAsociarItem_Prendas.frx":1580
      FormatStyle(6)  =   "frmAsociarItem_Prendas.frx":1638
      ImageCount      =   0
      PrinterProperties=   "frmAsociarItem_Prendas.frx":1718
   End
   Begin GridEX20.GridEX GridEX1 
      ...
      ColumnHeaderHeight=   285
      ColumnsCount    =   2
      Column(1)       =   "frmAsociarItem_Prendas.frx":18F0
      Column(2)       =   "frmAsociarItem_Prendas.frx":19B8
      FormatStylesCount=   8
      FormatStyle(1)  =   "frmAsociarItem_Prendas.frx":1A5C
      FormatStyle(2)  =   "frmAsociarItem_Prendas.frx":1B94
      FormatStyle(3)  =   "frmAsociarItem_Prendas.frx":1C44
      FormatStyle(4)  =   "frmAsociarItem_Prendas.frx":1CF8
      FormatStyle(5)  =   "frmAsociarItem_Prendas.frx":1DD0
      FormatStyle(6)  =   "frmAsociarItem_Prendas.frx":1E88
      FormatStyle(7)  =   "frmAsociarItem_Prendas.frx":1F68
      FormatStyle(8)  =   "frmAsociarItem_Prendas.frx":2014
      ImageCount      =   0
      PrinterProperties=   "frmAsociarItem_Prendas.frx":20C4
   End
   Begin FunctionsButtons.FunctButt FunctButt2 
      ...
      _ExtentX        =   5106
      _ExtentY        =   1111
      Custom          =   $"frmAsociarItem_Prendas.frx":229C
      Orientacion     =   0
      Style           =   1
      Language        =   0
      TypeImageList   =   0
   ...
   End
End
Attribute VB_Name = "frmAsociarItem_Prendas"
...
If Left(Cbo_Almacen, 2) = "62" Then
  sSql = "Ventas_Muestra_Documentos_xRegularizar_Facturar_Prendas '" & Left(Cbo_Almacen, 3) & "','" & dtpFecEmiIni & "','" & dtpFecEmiFin & "','" & IIf(optTodos, "*", "") & "','" & sCod_TipoFact & "','" & txtAbr_Cliente.Tag & "' ,'" & vusu & "'"
Else
  Exit Sub
End If
...
Private Sub FunctButt2_ActionClick(ByVal Index As Integer, ByVal ActionType As Integer, ByVal ActionName As String)
    ...
    Case "REGULARIZAR"
        ...
        Msg = MsgBox("¿Esta seguro de Regularizar la factura actual?", vbYesNo)
...
Select Case ColIndex
  Case Is = GridEX1.Columns("Sel").Index
      ...
      sSql = "Ventas_Cambio_Estado_Regularizacion_DocAlm_Prendas '$','$','$','$','$',$,'$',$,$,'$','$','$' ,'$','$','$','$',$,$,$,'$',$,'$','$','$','$','$','$','$','$','$',$,'$','$',$,$"
      ...
      sSql = VBsprintf(sSql, Left(Cbo_Almacen, 2), _
                       ...
                       GridEX1.Value(GridEX1.Columns("Pie_Factura2").Index), IIf(GridEX1.Value(GridEX1.Columns("Sel").Index) = 0, "P", "R"), GridEX1.Value(GridEX1.Columns("COD_ESTCLI").Index), GridEX1.Value(GridEX1.Columns("Fecha").Index), GridEX1.Value(GridEX1.Columns("Cod_Vendor").Index), GridEX1.Value(GridEX1.Columns("Cod_Class").Index), GridEX1.Value(GridEX1.Columns("Num_Embarque").Index), vusu, GridEX1.Value(GridEX1.Columns("Por_Comision").Index), GridEX1.Value(GridEX1.Columns("imp_Desaduanaje").Index), GridEX1.Value(GridEX1.Columns("Imp_Transporte_Pais_Destino").Index))
...
For I = 0 To GridEX1.RowCount
  ...
  If GridEX1.Value(GridEX1.Columns("SEL").Index) Then
    ...
    If Left(Cbo_Almacen, 2) = "62" Then
      ...
      ExecuteCommandSQL cCONNECT, sSql
      ExecuteCommandSQL cCONNECT, "Ventas_Asociar_Venta_Items_con_Ventas_Prendas '" & Left(Cbo_Almacen, 2) & "','" & GridEX1.Value(GridEX1.Columns("Ser_Factura").Index) & "','" & GridEX1.Value(GridEX1.Columns("Num_Factura").Index) & "','" & vusu & "'"
...
Dim rstAux As ADODB.Recordset
    ...
    frmBusqGeneral3.Caption = "Seleccione Cliente"
...
Dim rstAux As ADODB.Recordset
    ...
    Set frmBusqGeneral3.oParent = Me
    frmBusqGeneral3.Caption = "Tipo de Facturacion"
    frmBusqGeneral3.SQuery = strSQL
    frmBusqGeneral3.Cargar_Datos
    Set rstAux = frmBusqGeneral3.gexLista.ADORecordset
  ...
  For I = 0 To GridEX1.RowCount
    If Serie = GridEX1.Value(GridEX1.Columns("Ser_Factura").Index) And Nro_Factura = GridEX1.Value(GridEX1.Columns("Num_Factura").Index) Then
      ...
      sSql = VBsprintf(sSql, Left(Cbo_Almacen, 2), _
                       ...
                       GridEX1.Value(GridEX1.Columns("Nom_Embarque").Index), _
                       GridEX1.Value(GridEX1.Columns("Pie_Factura1").Index), _
                       GridEX1.Value(GridEX1.Columns("Pie_Factura2").Index), IIf(GridEX1.Value(GridEX1.Columns("Sel").Index) = 0, "P", "R"), GridEX1.Value(GridEX1.Columns("COD_ESTCLI").Index), GridEX1.Value(GridEX1.Columns("Fecha").Index), GridEX1.Value(GridEX1.Columns("Cod_Vendor").Index), GridEX1.Value(GridEX1.Columns("Cod_Class").Index), GridEX1.Value(GridEX1.Columns("Num_Embarque").Index), vusu, GridEX1.Value(GridEX1.Columns("Por_Comision").Index))
      ExecuteCommandSQL cCONNECT, sSql
