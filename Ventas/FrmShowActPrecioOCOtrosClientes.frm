...
Begin VB.Form FrmShowActPrecioOCOtrosClientes 
   Caption         =   "Ordenes Compra Otros Clientes"
   ClientHeight    =   5130
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10455
   ...
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   8811
      _ExtentY        =   900
      Custom          =   $"FrmShowActPrecioOCOtrosClientes.frx":0000
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   Begin GridEX20.GridEX GridEX1 
      ...
      ColumnsCount    =   2
      Column(1)       =   "FrmShowActPrecioOCOtrosClientes.frx":013E
      Column(2)       =   "FrmShowActPrecioOCOtrosClientes.frx":0206
      FormatStylesCount=   8
      FormatStyle(1)  =   "FrmShowActPrecioOCOtrosClientes.frx":02AA
      FormatStyle(2)  =   "FrmShowActPrecioOCOtrosClientes.frx":03E2
      FormatStyle(3)  =   "FrmShowActPrecioOCOtrosClientes.frx":0492
      FormatStyle(4)  =   "FrmShowActPrecioOCOtrosClientes.frx":0546
      FormatStyle(5)  =   "FrmShowActPrecioOCOtrosClientes.frx":061E
      FormatStyle(6)  =   "FrmShowActPrecioOCOtrosClientes.frx":06D6
      FormatStyle(7)  =   "FrmShowActPrecioOCOtrosClientes.frx":07B6
      FormatStyle(8)  =   "FrmShowActPrecioOCOtrosClientes.frx":0862
      ImageCount      =   0
      PrinterProperties=   "FrmShowActPrecioOCOtrosClientes.frx":0912
   End
End
Attribute VB_Name = "FrmShowActPrecioOCOtrosClientes"
