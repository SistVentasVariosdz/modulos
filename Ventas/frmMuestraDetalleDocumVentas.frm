...
Begin VB.Form frmMuestraDetalleDocumVentas 
   ...
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   11033
      _ExtentY        =   900
      Custom          =   $"frmMuestraDetalleDocumVentas.frx":0097
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   Begin GridEX20.GridEX GridEX1 
      ...
      ImageCount      =   1
      ImagePicture1   =   "frmMuestraDetalleDocumVentas.frx":0217
      DataMode        =   1
      ColumnHeaderHeight=   285
      ColumnsCount    =   2
      Column(1)       =   "frmMuestraDetalleDocumVentas.frx":0569
      Column(2)       =   "frmMuestraDetalleDocumVentas.frx":0631
      FormatStylesCount=   8
      FormatStyle(1)  =   "frmMuestraDetalleDocumVentas.frx":06D5
      FormatStyle(2)  =   "frmMuestraDetalleDocumVentas.frx":080D
      FormatStyle(3)  =   "frmMuestraDetalleDocumVentas.frx":08BD
      FormatStyle(4)  =   "frmMuestraDetalleDocumVentas.frx":0971
      FormatStyle(5)  =   "frmMuestraDetalleDocumVentas.frx":0A49
      FormatStyle(6)  =   "frmMuestraDetalleDocumVentas.frx":0B01
      FormatStyle(7)  =   "frmMuestraDetalleDocumVentas.frx":0BE1
      FormatStyle(8)  =   "frmMuestraDetalleDocumVentas.frx":1099
      ImageCount      =   1
      ImagePicture(1) =   "frmMuestraDetalleDocumVentas.frx":14E5
      PrinterProperties=   "frmMuestraDetalleDocumVentas.frx":1837
   End
End
