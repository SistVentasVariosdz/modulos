...
Public sPrefijoTablaASIENTOSLIM As String
Public sPrefijoTablaSLIM As String

Public bCargaConexion As Boolean
Public gvcrRpt As Report
...
Public Function get_botones1(ByRef F As Form, ByVal Vcod_perfil As Variant, ByVal vcod_empresa As Variant, ByVal fname As Variant)
On Error GoTo hand
