...
Begin VB.Form frmShowFactVentas_Liquidar 
   Caption         =   " Liquidar Facturas"
   ClientHeight    =   4725
   ClientLeft      =   180
   ClientTop       =   495
   ClientWidth     =   14490
   Icon            =   "Frm_liquidarFactura.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   4725
   ScaleWidth      =   14490
   ...
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   2725
      _ExtentY        =   5265
      Custom          =   $"Frm_liquidarFactura.frx":030A
      Orientacion     =   1
      Style           =   1
      Language        =   0
      TypeImageList   =   0
   ...
   Begin GridEX20.GridEX GridEX1 
      ...
      ColumnsCount    =   2
      Column(1)       =   "Frm_liquidarFactura.frx":04FC
      Column(2)       =   "Frm_liquidarFactura.frx":05C4
      FormatStylesCount=   8
      FormatStyle(1)  =   "Frm_liquidarFactura.frx":0668
      FormatStyle(2)  =   "Frm_liquidarFactura.frx":07A0
      FormatStyle(3)  =   "Frm_liquidarFactura.frx":0850
      FormatStyle(4)  =   "Frm_liquidarFactura.frx":0904
      FormatStyle(5)  =   "Frm_liquidarFactura.frx":09DC
      FormatStyle(6)  =   "Frm_liquidarFactura.frx":0A94
      FormatStyle(7)  =   "Frm_liquidarFactura.frx":0B74
      FormatStyle(8)  =   "Frm_liquidarFactura.frx":0C20
      ImageCount      =   0
      PrinterProperties=   "Frm_liquidarFactura.frx":0CD0
   End
   ...
   End
End
Attribute VB_Name = "frmShowFactVentas_Liquidar"
...
sSQL = "Ventas_Muestra_Doc_Ventas_otros '" & strOpcion & "','" & dtpFecEmiIni & "','" & dtpFecEmiFin & "','" & "C" & "','" & strCod_Anxo & "','" & txtAno & "','" & txtMes & "','','" & txtCod_TipDoc & "','" & txtSer_Docum & "','" & txtNum_Docum & "','" & vusu & "',''"
...
GridEX1.Columns("Imp_Gastos_Financieros").Width = 0
GridEX1.Columns("Imp_Total").Width = 840
GridEX1.Columns("Imp_Total").Caption = "Imp Total"

GridEX1.Columns("Imp_Total_Otros").Width = 840
GridEX1.Columns("Imp_Total_Otros").Caption = "Imp Otros"

GridEX1.Columns("Imp_Otros").Width = 0
...
GridEX1.Columns("Registro").Width = 0
GridEX1.Columns("Vencimiento").Width = 0

GridEX1.Columns("imp_desaduanaje").Width = 0
GridEX1.Columns("Imp_Transporte_Pais_Destino").Width = 0
GridEX1.Columns("Imp_Flete").Width = 0
GridEX1.Columns("IMP_FOB").Width = 0
GridEX1.Columns("IMP_CIF").Width = 0
GridEX1.Columns("IMP_LDP").Width = 0
GridEX1.Columns("IMP_DDP").Width = 0

GridEX1.Columns("porc_igv").Width = 0
GridEX1.Columns("imp_descuento").Width = 0
...
drpsiguiente:
    ...
    Case "VERDETALLE"
      ...
      Load frmMuestraDetalleDocumVentas_liquidar
      With frmMuestraDetalleDocumVentas_liquidar
        ...
        .strSQL = "Ventas_Muestra_Detalle_Factura_Items_otros '" & GridEX1.Value(GridEX1.Columns("Num_Corre").Index) & "'"
...
If rs.RecordCount Then
    ...
    sUnd = "KG"
        ...
        If sCod_almacen = "31" Then
            ...
            strCadena = Space(14) & AlExp(rs!Kilos, 18) & Space(13) & AlExp(Mid(sDescripcion, 1, iMaxLen), 50) & Space(5) & AlExp(rs!precio, 10) & Space(6) & AlExp(rs!ImporteTela, 10)
            Plin strCadena
       End If
        If sCod_almacen = "30" Then
            strCadena = Space(14) & AlExp(rs!Kilos, 18) & Space(10) & AlExp(Mid(rs!Ruta, 1, 50), 50) & Space(2) & AlExp(rs!precio, 10) & Space(5) & AlExp(rs!ImporteTela, 10)
            Plin strCadena
     End If
...
Dim oo As Object, vRutaLogo As Variant, _
    ...
    Set rs = CargarRecordSetDesconectado("Ventas_Muestra_Detalle_Factura_Items_otros '" & GridEX1.Value(GridEX1.Columns("Num_Corre").Index) & "'", cCONNECT)

    
    If rs.RecordCount > 0 Then
        sTitulo = GridEX1.Value(GridEX1.Columns("Nro_Doc").Index)
        ...
        If MsgBox("Desea imprimir usando Microsoft Excel?", vbQuestion + vbYesNo, "Imprimir") = vbYes Then
            ...
            oo.Run "REPORTE", CStr(sRutaLogo), rs, sTitulo, GridEX1.Value(GridEX1.Columns("Anexo").Index) & "'"
...
Dim oo As Object, vRutaLogo As Variant, _
    ...
    If GridEX1.RowCount > 0 Then
            ...
            Set oo = CreateObject("excel.application")
            oo.Workbooks.Open vRuta & "\RptDetalleCtaCte.XLT"
            oo.DisplayAlerts = False
            oo.Visible = True
            
            
            
            oo.Run "REPORTE", CStr(sRutaLogo), GridEX1.ADORecordset, sTitulo, txtDes_Anexo.Text & "'"
...
Dim oo As Object, vRutaLogo As Variant, _
    ...
    Set rs = CargarRecordSetDesconectado("Ti_Muestra_Detalle_General 'C','" & scodclienteAne & "','" & dtpFecEmiIni & "','" & dtpFecEmiFin & "'", cCONNECT)
    ...
    If rs.RecordCount > 0 Then
        ...
        If MsgBox("Desea imprimir usando Microsoft Excel?", vbQuestion + vbYesNo, "Imprimir") = vbYes Then
            Set oo = CreateObject("excel.application")
            oo.Workbooks.Open vRuta & "\RptDetalleGeneral.XLT"
            oo.DisplayAlerts = False
            oo.Visible = True
            
            
            
            oo.Run "REPORTE", CStr(sRutaLogo), rs, sTitulo, GridEX1.Value(GridEX1.Columns("Anexo").Index), dtpFecEmiIni, dtpFecEmiFin
