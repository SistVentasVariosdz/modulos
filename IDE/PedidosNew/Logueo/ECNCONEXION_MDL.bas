...
Public Const PU_003_Ks_ECNOVL_LINEA_ECNOVL_BDN_SEGU As String = "[BDN_SEGU]"
Public Const PU_003_Ks_ECNOVL_LINEA_ECNOVL_SQL_CONE As String = "[SQL_CONE]"
Public Const PU_003_Ks_ECNOVL_LINEA_ECNOVL_SQL_CONE_SEGU As String = "[SQL_CSEG]"
...
Global GO_003_BD_SEG As String
Global GO_003_CONEXION_SQL As String
Global GO_003_CONEXION_SQL_SEG As String
...
Public PU_003_BDS As String

Public PU_003_CONNECT As String
Public PU_003_CONNECT_SEGU As String
...
Public Sub PU_003_CrearECNOVL(ByVal sSQLServ As String, _
                       ...
                       ByVal sBDNImag As String, _
                       ByVal sBDNSegu As String)
    ...
    sSQLCadConSegu = "Provider=SQLOLEDB;" _
               & "Data Source=" & sSQLServ & ";" _
               & "Initial Catalog=" & sBDNSegu & ";" _
               & "Uid=" & sSQLUser & ";" _
               & "Pwd=" & sSQLUpwd & ";"

'    sXLSCadCon "Provider=SQLOLEDB.1;" _
'                & "Integrated Security=SSPI;Persist Security Info=False;" _
'                & "Initial Catalog=" & sBDNMain & ";" _
'                & "Data Source=" & sSQLServ & ";"
    
    
'     sSQLCadConSegu "Provider=SQLOLEDB.1;" _
'                & "Integrated Security=SSPI;Persist Security Info=False;" _
'                & "Initial Catalog=" & sBDNSegu & ";" _
'                & "Data Source=" & sSQLServ & ";"
    ...
    sCadena = PU_003_Ks_ECNOVL_LINEA_ECNOVL_BDN_SEGU & "=" & sBDNSegu
    Print #1, PU_003_ECNLIB01_FUNSUB.Cript2(Trim(sCadena))
    
    sCadena = PU_003_Ks_ECNOVL_LINEA_ECNOVL_SQL_CONE & "=" & sSQLCadCon
    Print #1, PU_003_ECNLIB01_FUNSUB.Cript2(Trim(sCadena))
    
    sCadena = PU_003_Ks_ECNOVL_LINEA_ECNOVL_SQL_CONE_SEGU & "=" & sSQLCadConSegu
    Print #1, PU_003_ECNLIB01_FUNSUB.Cript2(Trim(sCadena))
...
Public Function PU_003_LeerECNOVL() As Boolean
    ...
    Do While Not EOF(n)
        ...
        lPosCadFnd = InStr(sCadena, PU_003_Ks_ECNOVL_LINEA_ECNOVL_BDN_SEGU): If lPosCadFnd > 0 Then GO_003_BD_SEG = Mid(sCadena, 12)
        ...
        If stipo = PU_003_Ks_ECNOVL_LINEA_ECNOVL_SERVIDOR Then
            ...
            lPosCadFnd = InStr(sCadena, PU_003_Ks_ECNOVL_LINEA_ECNOVL_SQL_CONE_SEGU): If lPosCadFnd > 0 Then GO_003_CONEXION_SQL_SEG = Mid(sCadena, 12)
