...
Public Event BeforeChangeText(ByVal irow As Long, _
...
'AHSP
Public Sub BUSCACAMPO_FLEX(varNumColumna As Integer, _
                           varValor As String, _
                           varFlexGrid As MSFlexGrid)
