...
Private Declare Function EnumSystemLocales _
                Lib "Kernel32" _
                Alias "EnumSystemLocalesA" (ByVal lpLocaleEnumProc As Long, _
                                            ByVal dwFlags As Long) As Long

Private Declare Function EnumCalendarInfo _
                Lib "Kernel32" _
                Alias "EnumCalendarInfoA" (ByVal lpCalInfoEnumProc As Long, _
                                           ByVal Locale As Long, _
                                           ByVal Calendar As Long, _
                                           ByVal CalType As Long) As Long

Private Declare Function EnumDateFormats _
                Lib "Kernel32" _
                Alias "EnumDateFormatsA" (ByVal lpDateFmtEnumProc As Long, _
                                          ByVal Locale As Long, _
                                          ByVal dwFlags As Long) As Long

Private Declare Function GetCurrencyFormatBynum _
                Lib "Kernel32" _
                Alias "GetCurrencyFormatA" (ByVal Locale As Long, _
