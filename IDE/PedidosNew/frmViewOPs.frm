...
Begin VB.Form frmViewOPs 
   ...
   Begin SSDataWidgets_B.SSDBGrid ssgrdDatos 
      ...
      Columns(10).Name=   "num_solicitud_costeo_asignada"
      Columns(10).DataField=   "Column 10"
      Columns(10).DataType=   8
      Columns(10).FieldLen=   256
      Columns(11).Width=   3200
      Columns(11).Caption=   "Estilo Prov"
      Columns(11).Name=   "Cod_Estpro_asignada"
      Columns(11).DataField=   "Column 11"
      Columns(11).DataType=   8
      Columns(11).FieldLen=   256
      Columns(12).Width=   3200
      Columns(12).Caption=   "Version Asignada"
      Columns(12).Name=   "cod_version_asignada"
...
Private Sub FunctButt2_ActionClick(ByVal Index As Integer, _
    ...
    Select Case ActionName
        ...
        Case "VERSIONCOSTEO"
            ...
            frmVersionCosteo.txtCotizacion.Text = Me.ssgrdDatos.Columns("num_solicitud_costeo_asignada").Text
            frmVersionCosteo.txtCod_EstPro.Text = Me.ssgrdDatos.Columns("cod_estpro_asignada").Text
            frmVersionCosteo.txtCod_Version.Text = Me.ssgrdDatos.Columns("cod_version_asignada").Text
