...
Public Function CambiarContenedor(ByRef oContenedor As Form, _
                                  Optional ByVal strTitulo As String = "")

    Dim retvalue

    SetParent Me.cmdImprimir.hwnd, oContenedor.hwnd
    Me.Caption = IIf(strTitulo = "", oContenedor.Caption, strTitulo)
...
Sub Reporte(ByVal sTitulo As String, ByVal adoRs As ADODB.Recordset)
    ...
    If MsgBox("Desea imprimir usando Microsoft Excel?", vbQuestion + vbYesNo, "Barra de Impresión") = vbYes Then
    ...
    Else
        ...
        oo.Run sTitulo, adoRs.source, vemp, cCONNECT
    End If
