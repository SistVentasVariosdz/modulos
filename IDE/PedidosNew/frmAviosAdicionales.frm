...
Begin VB.Form frmAviosAdicionales 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin GridEX20.GridEX gexLista 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAviosAdicionales.frx":0A70
         Column(2)       =   "frmAviosAdicionales.frx":0B38
         FormatStylesCount=   6
         FormatStyle(1)  =   "frmAviosAdicionales.frx":0BDC
         FormatStyle(2)  =   "frmAviosAdicionales.frx":0D14
         FormatStyle(3)  =   "frmAviosAdicionales.frx":0DC4
         FormatStyle(4)  =   "frmAviosAdicionales.frx":0E78
         FormatStyle(5)  =   "frmAviosAdicionales.frx":0F50
         FormatStyle(6)  =   "frmAviosAdicionales.frx":1008
         ImageCount      =   0
         PrinterProperties=   "frmAviosAdicionales.frx":10E8
      End
...
Public Function CARGA_GRID() As Boolean
    ...
    strSql = "EXEC SM_SEL_LOTESTPRO_AVIOS_ADICIONALES '" & sCod_Cliente & "','" & sCod_PurOrd & "','" & sCod_LotPurOrd & "','" & sCod_EstCli & "','" & sCod_EstPro & "'"
...
Sub SALVAR_DATOS()
    ...
    strSql = "EXEC UP_MAN_TG_LOTESTPRO_AVIOS '" & stipo & "','" & sCod_Cliente & "','" & sCod_PurOrd & "','" & sCod_LotPurOrd & "','" & sCod_EstCli & "','" & sCod_EstPro & "','" & txtCod_Item.Text & "','" & txtCod_Comb.Text & "'," & TxtCantidad.Text & ",'" & sCod_CompEst & "'," & txtCod_Present & ",'" & txtNro_No_Conformidad.Text & "'"
