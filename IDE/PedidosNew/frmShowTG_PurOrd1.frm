...
Begin VB.Form frmShowTG_PurOrd 
   ...
   ClientTop       =   345
   ClientWidth     =   11505
   Icon            =   "frmShowTG_PurOrd1.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7590
   ScaleWidth      =   11505
   ...
   Begin FunctionsButtons.FunctButt FunctButt2 
      ...
      _ExtentX        =   19950
      _ExtentY        =   900
      Custom          =   $"frmShowTG_PurOrd1.frx":0442
      Orientacion     =   0
      Style           =   0
      Language        =   2
      TypeImageList   =   0
   ...
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   2117
      _ExtentY        =   7011
      Custom          =   $"frmShowTG_PurOrd1.frx":0919
      Orientacion     =   1
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   Begin FunctionsButtons.FunctButt FunctButt4 
      ...
      _ExtentX        =   1693
      _ExtentY        =   900
      Custom          =   "0~0~MODIFICARDET~True~True~Asigna Nro Despacho~0~0~~Modificar~0~False~False~Asigna Nro Despacho~Modificar"
      Orientacion     =   0
      Style           =   0
      Language        =   2
      TypeImageList   =   0
