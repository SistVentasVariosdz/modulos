...
Sub ACTUALIZAR(pCliente As String, _
               pPO As String, _
               pEstilo As String, _
               pTalla As String, _
               pOrden As Integer, _
               Num_Partida_Arancelaria As String, _
               Sec_Partida_Arancelaria As String, _
               Num_Categoria_Internacional As String, _
               Num_Partida_Arancelaria_Exterior As String)
...
Sub INSERTAR(pCliente As String, _
             pPO As String, _
             pEstilo As String, _
             pTalla As String, _
             pOrden As Integer, _
