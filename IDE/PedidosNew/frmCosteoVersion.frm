...
Begin VB.Form frmVersionCosteo 
   ...
   Begin FunctionsButtons.FunctButt FunctButt1 
      ...
      _ExtentX        =   4339
      _ExtentY        =   900
      Custom          =   $"frmCosteoVersion.frx":0000
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
...
Sub SALVAR_DATOS()
    ...
    strSql = "EXEC UP_MAN_TG_LOTESTPRO_VERSIONES_COSTEO '" & sCod_Cliente & "','" & sCod_PurOrd & "','" & sCod_LotPurOrd & "','" & sCod_EstCli & "','" & sCod_EstPro & "'," & txtCotizacion.Text & ",'" & txtcod_estpro.Text & "','" & txtCod_Version.Text & "'"
