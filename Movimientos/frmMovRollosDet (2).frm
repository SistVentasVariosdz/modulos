...
'            Exit Sub
	...
	StrSql = "SELECT a.Cod_OrdTra, a.Num_Secuencia, a.Num_Rollo, b.Cod_Tela, " & _
             "Des_Tela, " & _
             "a.Flg_Status, a.Peso_Rollo_Actual, a.Unidades_Rollo_Actual, a.Cod_Calidad " & _
             ", d.Cod_TipoOC_Tejeduria, e.Des_TipoOC_Tejeduria, f.Abr_Cliente, " & _
             "b.Kilos_Requeridos " & _
             "FROM TJ_ORDTRA_TEJEDURIA_ROLLOS a, TJ_ORDTRA_ITEMS b, " & _
             "TX_TELA  c, LG_ORDCOMP d, TX_TIPO_OC_TEJEDURIA e, " & _
             "TG_CLIENTE f WHERE a.Codigo_Rollo = '" & sCodRollo & "' " & _
             "AND a.Prefijo_Maquina = '" & sPrefMaq & "' " & _
             "AND a.Num_Despacho = 0 " & _
             "AND b.Cod_OrdTra = a.Cod_OrdTra " & _
			 "AND b.Num_Secuencia = a.Num_Secuencia " & _
             "AND c.Cod_Tela = b.Cod_Tela " & _
             "AND d.Cod_Cliente_Tex = b.Cod_Cliente_Tex " & _
             "AND d.Ser_OrdComp = b.Ser_OrdComp " & _
             "AND d.Cod_OrdComp = b.Cod_OrdComp " & _
             "AND e.Cod_TipoOC_Tejeduria = d.Cod_TipoOC_Tejeduria " & _
