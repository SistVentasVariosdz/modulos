...
Begin VB.Form frmDetTelCruEnt 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin GridEX20.GridEX gexLotes 
         ...
         ColumnsCount    =   2
         Column(1)       =   "frmDetTelCruEnt.frx":0000
         Column(2)       =   "frmDetTelCruEnt.frx":00C8
         FormatStylesCount=   6
         FormatStyle(1)  =   "frmDetTelCruEnt.frx":016C
         FormatStyle(2)  =   "frmDetTelCruEnt.frx":02A4
         FormatStyle(3)  =   "frmDetTelCruEnt.frx":0354
         FormatStyle(4)  =   "frmDetTelCruEnt.frx":0408
         FormatStyle(5)  =   "frmDetTelCruEnt.frx":04E0
         FormatStyle(6)  =   "frmDetTelCruEnt.frx":0598
         ImageCount      =   0
         PrinterProperties=   "frmDetTelCruEnt.frx":0678
      End
   End
End
Attribute VB_Name = "frmDetTelCruEnt"
...
Dim Strsql As String
    ...
    Strsql = "EXEC SM_AYUDA_DEVOLUCION_TELA_CRUDA_DE_PARTIDAS '" & vCod_OrdTra & "'"
    ...
    With gexLotes
        ...
        .Columns("COD_MEDIDA").Caption = "Cod.Medida"
        ...
        .Columns("COD_TELA").Width = 1000
        .Columns("DES_TELA").Width = 2000
        .Columns("COD_COMB").Width = 1000
        .Columns("DES_COMB").Width = 1000
        .Columns("COD_MEDIDA").Width = 1000
        .Columns("MEDIDA").Width = 1000
