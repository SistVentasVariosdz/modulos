...
Begin VB.Form frmControlGuias 
   ...
   Begin Mantenimientos.MantFunc MantFunc1 
      ...
      _ExtentX        =   5212
      _ExtentY        =   953
      Custom          =   $"frmControlGuias.frx":030A
      Orientacion     =   0
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   Begin VB.Frame Frame2 
      ...
      Begin GridEX20.GridEX gexList 
         ...
         ImageCount      =   3
         ImagePicture1   =   "frmControlGuias.frx":046E
         ImagePicture2   =   "frmControlGuias.frx":0580
         ImagePicture3   =   "frmControlGuias.frx":089A
         RowHeaders      =   -1  'True
         DataMode        =   1
         ...
         SortKeysCount   =   1
         SortKey(1)      =   "frmControlGuias.frx":0BB4
         FormatStylesCount=   6
         FormatStyle(1)  =   "frmControlGuias.frx":0C1C
         FormatStyle(2)  =   "frmControlGuias.frx":0CFC
         FormatStyle(3)  =   "frmControlGuias.frx":0E24
         FormatStyle(4)  =   "frmControlGuias.frx":0ED4
         FormatStyle(5)  =   "frmControlGuias.frx":0F88
         FormatStyle(6)  =   "frmControlGuias.frx":1060
         ImageCount      =   3
         ImagePicture(1) =   "frmControlGuias.frx":1118
         ImagePicture(2) =   "frmControlGuias.frx":122A
         ImagePicture(3) =   "frmControlGuias.frx":1544
         PrinterProperties=   "frmControlGuias.frx":185E
      End
   End
