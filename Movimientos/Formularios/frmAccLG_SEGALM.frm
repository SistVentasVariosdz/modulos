...
Begin VB.Form frmAccLG_SEGALM 
   Caption         =   "Acceso por Almacen (LG)"
   ClientHeight    =   5775
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8235
   ...
   Begin FunctionsButtons.FunctButt FunctButt2 
      ...
      _ExtentX        =   1138
      _ExtentY        =   4286
      Custom          =   $"frmAccLG_SEGALM.frx":0000
      Orientacion     =   1
      Style           =   0
      Language        =   0
      TypeImageList   =   0
   ...
   Begin GridEX20.GridEX gexLgconAcc 
      ...
      IntProp7        =   0
      ColumnsCount    =   2
      Column(1)       =   "frmAccLG_SEGALM.frx":00C5
      Column(2)       =   "frmAccLG_SEGALM.frx":018D
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmAccLG_SEGALM.frx":0231
      FormatStyle(2)  =   "frmAccLG_SEGALM.frx":0369
      FormatStyle(3)  =   "frmAccLG_SEGALM.frx":0419
      FormatStyle(4)  =   "frmAccLG_SEGALM.frx":04CD
      FormatStyle(5)  =   "frmAccLG_SEGALM.frx":05A5
      FormatStyle(6)  =   "frmAccLG_SEGALM.frx":065D
      ImageCount      =   0
      PrinterProperties=   "frmAccLG_SEGALM.frx":073D
   End
   Begin GridEX20.GridEX gexLgsinAcc 
      ...
      IntProp7        =   0
      ColumnsCount    =   2
      Column(1)       =   "frmAccLG_SEGALM.frx":0915
      Column(2)       =   "frmAccLG_SEGALM.frx":09DD
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmAccLG_SEGALM.frx":0A81
      FormatStyle(2)  =   "frmAccLG_SEGALM.frx":0BB9
      FormatStyle(3)  =   "frmAccLG_SEGALM.frx":0C69
      FormatStyle(4)  =   "frmAccLG_SEGALM.frx":0D1D
      FormatStyle(5)  =   "frmAccLG_SEGALM.frx":0DF5
      FormatStyle(6)  =   "frmAccLG_SEGALM.frx":0EAD
      ImageCount      =   0
      PrinterProperties=   "frmAccLG_SEGALM.frx":0F8D
   End
   ...
   End
End
Attribute VB_Name = "frmAccLG_SEGALM"
...
Dim rstAux As ADODB.Recordset
    Strsql = "SELECT Cod_Almacen, Nom_Almacen FROM LG_ALMACEN"
...
Strsql = "SELECT Cod_Usuario, Nom_Usuario FROM Seguridad.dbo.SEG_USUARIOS " & _
         "WHERE  Cod_Usuario NOT IN (SELECT Cod_Usuario FROM LG_SEGALM " & _
...
'Usuario con acceso restringido al Almacen especificado
Strsql = "SELECT a.Cod_Usuario, b.Nom_Usuario FROM LG_SEGALM a, " & _
...
On Error GoTo Fin
    ActAccAlm = False
    Strsql = "EXEC UP_MAN_LG_SEGALM '" & Accion & "', '" & Cod_Usuario & _
             "', '" & sCod_Almacen & "'"
